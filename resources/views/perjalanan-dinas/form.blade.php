            ...
            <div class="row justify-content-start align-items-end">
                <div class="col-lg-3">
                    <div class='bagan_form'>
                        <label for="nm_karyawan" class="form-label">Pilih Karyawan <span
                        ...
                        <div class="button-icon-inside">
                            ...
                            <input type="hidden" id="id_karyawan" name='id_karyawan' required
                                value="{{ !empty($model->id_karyawan) ? $model->id_karyawan : '' }}">
                            <span class="modal-remote-data" data-modal-src="{{ url('ajax?action=get_list_karyawan') }}"
                                data-modal-key="" data-modal-pencarian='true' data-modal-title='Data Karyawan'
                                data-modal-width='80%'
                ...
                <div class="col-lg-2">
                    <label for="test" class="form-label">Jenis Perjalanan Dinas <span
                            class="text-danger">*</span></label>
                ...
                <div class="col-lg-3" id="tanggalLuarKota"
                    ...
                    <div class='bagan_form'>
                        ...
                        <div class="input-group input-date-range-bagan">
                            <input type="text" class="form-control input-date-range" id="tanggal_data"
                                placeholder="Tanggal">
                            <input type="hidden" id="tgl_start" name="tgl_mulai"
                                value="{{ !empty($model->tgl_mulai) ? $model->tgl_mulai : '' }}">
                            <input type="hidden" id="tgl_end" name="tgl_selesai"
                                value="{{ !empty($model->tgl_selesai) ? $model->tgl_selesai : '' }}">
                            <span class="input-group-text bg-primary">
                                <i class="fa-solid fa-calendar-days text-white"></i>
                            </span>
                        </div>
                    ...
                    <div class='bagan_form'>
                        <div class="bagan_form">
                            ...
                            <input type="number" class="form-control" id="jumlah" name="jumlah" min='1'
                                value="{{ !empty($model->jumlah) ? $model->jumlah : '0' }}" readonly>
                        </div>
                        <div class="message"></div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class='bagan_form'>
                        ...
                        <input type="text" class="form-control" id="uraian" name='uraian' required
                            value="{{ !empty($model->uraian) ? $model->uraian : '' }}">
                        <div class="message"></div>
                    </div>
                </div>
            </div>
