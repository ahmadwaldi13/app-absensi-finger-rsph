...
@section('title-header', 'Data Pasien Rawat Jalan')
            ...
            <table class="table border table-responsive-tablet" id="tableRawatJalan">
                <thead>
                    <tr>
                        ...
                        <th class="py-4" style="text-align: center;">Status Poli</th>
                        <?php if($get_user->type_user=='dokter'){ ?>
                ...
                <tbody>
                    ...
                    <tr {{ $style_tr }}>
                        ...
                        <td class="py-3" style="text-align: center;">{{ $item["status_poli"] }}</td>
                        <?php if($get_user->type_user=='dokter'){ ?>
                            <td class="py-3" style="text-align: center;">{{ $check_operasi }}</td>
                        <?php } ?>
                        <?php $url_tindakan_rekam_medis='tindakan-rekam-medis/ralan' ?>
