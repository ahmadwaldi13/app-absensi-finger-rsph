...
@section('title-header', 'SOAP Farmasi')
            ...
            <div class="row d-flex align-items-end mt-0">
                <div class="col-xl-3 col-12 my-3">
                    ...
                    <div class="button-icon-inside">
                        ...
                        <input type="hidden" name="bansal" id="valueRoom" />
                        <span id="modalKamar">
                ...
                <div class="col-md-1 d-flex justify-center col-1">
                    <input name="tab" type="text" value="{{$tab}}" hidden>
                    <button type="submit" id="submit" class="btn btn-primary mb-4">
                ...
                <table class="table border table-striped table-responsive-tablet" id="tableRawatJalan">
                    <thead>
                        <tr>
                            ...
                            <th span="2" class="py-4">No Rekam Medis</th>
                            <th span="2" class="py-4">Nama Pasien</th>
                            <th span="2" class="py-4">Nama Dokter</th>
                            <th span="2" class="py-4">Nama Bangsal</th>
                            <th span="2" class="py-4">Tanggal SOAP</th>
                            <th span="2" class="py-4">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <div class="py-1 pe-4 text-primary" style="text-align: center;">
                                        <a href="{{ url('/') }}/soap-farmasi-berkas/data-soap-farmasi?no_rawat={{ $item['no_rawat'] }}&no_rm={{ $item['no_rkm_medis'] }}&fr=ri"
                                            target="_blank" class="btn btn-primary">Cetak SOAP</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
