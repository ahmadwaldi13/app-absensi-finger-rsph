...
<script type="text/javascript" src="{{ asset('libs\datatables\1.10.11\buttons\1.1.2\js\buttons.html5.min.js' )}}">
</script>
...
<div>
    ...
    <form action="" method="GET">
        ...
        <div class="card border-top-0 px-4 py-5">
            <div class="row d-flex align-items-end mt-0">
                <div class="col-xl-3 col-12 my-3">
                    ...
                    <div class="button-icon-inside">
                        ...
                        <span id="modalKamar">
                            ...
                            <img class="iconify hover-pointer text-primary" src="{{ asset('') }}icon/selected.png"
                                alt="">
                        </span>
                    </div>
                </div>
                <div class="col-xl-3 col-12 my-3">
                    ...
                    <input type="text" class="form-control" id="pencarianralan" value="" placeholder="Masukkan Kata"
                        name="search" />
                </div>
                <div class="col-xl-3 col-10 my-3">
                    <label for="daterangeRalan" class="form-label">Periode Waktu</label>
                    <input type="text" class="form-control input-daterange" id="daterangeRanap"
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>Status</td>
                                        <td>: {{ $item["status_lanjut"] }} ({{ $item["png_jawab"] }})</td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    ...
                                    <div class="py-1 pe-4 text-primary" style="text-align: center;">
                                        <a href="{{ url('/') }}/berkas-digital/data-klaim?no_rawat={{ $item['no_rawat'] }}&no_rm={{ $item['no_rkm_medis'] }}&fr=ri"
                                            target="_blank" class="btn btn-primary">Lihat Data Klaim</a>
                                    </div>
                                    <div class="py-1 pe-4 text-primary" style="text-align: center;">
                                        <a onclick='UnggahBerkas(<?=json_encode($item)?>)'
                                            class="btn btn-primary">Unggah Berkas Pasien</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="row">
                <div class="col">
                    <div class="d-flex flex-row align-items-center">
                        ...
                        <select class="form-select ms-3" name="per_page" id="per_page" onchange="doSubmit(this)"
                            aria-label="Default select example" style="width: 100px;" id="row-data">
                            @foreach($perPageList as $raw)
                            <option @if($loop->first) selected @endif value="{{ number_format($raw) }}"
                                class="raw-data">{{ $raw }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <button type="button" style="display: none;" id="showModal" class="btn btn-primary"
                            ...
                            <div class="modal-header border-0 pb-0">
                                <div class="col-10">
                                    <div class="d-flex justify-content-center align-items-center border">
                                        <input type="text" class="form-control border-0" id="pencarianKamar"
                                ...
                                <table class="table border display nowrap" id="tableKamar">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td class="py-3"> <span class="text-primary hover-pointer"
                                                    onclick="setValue('{{ $room }}', '{{ $name }}')">{{ $name }}</span>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
