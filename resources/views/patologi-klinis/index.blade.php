...
@section('content')
    <div>
        @include('layouts.tab_lab',['active'=>1])
        <div class="card border-top-0 px-4 py-5">

            @include('patologi-klinis.form')
    
            @include('patologi-klinis.columns')
        </div>
    </div>
@endsection
...
@push('custom-script')
    ...
    <script src="{{ asset('js/patologi-klinis/patologi_klinis.js') }}"></script>
@endpush