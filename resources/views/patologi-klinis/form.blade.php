...
<form id="formIsiResume" action="{{ url($action_form) }}" method="{{ !empty($method_form) ? $method_form : 'POST' }}">
    ...
    <div class="row justify-content-start align-items-end mb-3">
        <div class="col-lg-6 mb-3">
            <div class='bagan_form'>
                ...
                <textarea class="form-control" id="indikasi" name="diagnosa_klinis" required rows="5">{{ !empty($model->diagnosa_klinis) ? $model->diagnosa_klinis :  "" }}</textarea>
                <div class="message"></div>
            </div>
        </div>
        <div class="col-lg-6 mb-3">
            <div class='bagan_form'>
                ...
                <textarea class="form-control" id="informasi_tambahan" name="informasi_tambahan" rows="5">{{ !empty($model->informasi_tambahan) ? $model->informasi_tambahan :  "" }}</textarea>
                <div class="message"></div>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <input type="hidden" id="periksa_sub_tmp" value="{{ !empty(Request::get('pds')) ? Request::get('pds') : '' }}"  >
        <div id='tamplate_lab'></div>
