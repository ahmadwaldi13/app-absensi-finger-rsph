                ...
                <tbody data-jml="">
                    @foreach($item as $key => $value)
                        <tr>
                            ...
                            <td class="py-3 border" >Permintaan</td>
                            <td class="py-3 border" ></td>
                            <td class="py-3 border" ></td>
                            <td class="py-3 border" ></td>
                            <td class="py-3 border" ></td>
                            <td class="py-3 border" ></td>
                            <td class="py-3 border" >Nilai Rujukan L.D</td>
                            <td class="py-3 border" >Nilai Rujukan L.A</td>
                            <td class="py-3 border" >Nilai Rujukan P.D</td>
                            <td class="py-3 border" >Nilai Rujukan P.A</td>
                            <td class="py-3 border" ></td>
                        </tr>
                        @php
                            $item_detail=!empty($list_pdp_lab[$value->kd_jenis_prw]) ? $list_pdp_lab[$value->kd_jenis_prw] : [];
                        @endphp
                        @if( !empty($item_detail) )
                            @foreach($item_detail as $key_1 => $value_1)
                                <tr>
                                    <td class="py-3 border" ></td>
                                    <td class="py-3 border" ></td>    
                                    <td class="py-3 border" >{{ !empty($value_1->Pemeriksaan) ? $value_1->Pemeriksaan : ''  }}</td>
                                    <td class="py-3 border" >{{ !empty($value_1->satuan) ? $value_1->satuan : ''  }}</td>
                                    <td class="py-3 border" ></td>
                                    <td class="py-3 border" ></td>
                                    <td class="py-3 border" ></td>
                                    <td class="py-3 border" ></td>
                                    <td class="py-3 border" ></td>
                                    <td class="py-3 border" >{{ !empty($value_1->nilai_rujukan_ld) ? $value_1->nilai_rujukan_ld : ''  }}</td>
                                    <td class="py-3 border" >{{ !empty($value_1->nilai_rujukan_la) ? $value_1->nilai_rujukan_la : ''  }}</td>
                                    <td class="py-3 border" >{{ !empty($value_1->nilai_rujukan_pd) ? $value_1->nilai_rujukan_pd : ''  }}</td>
                                    <td class="py-3 border" >{{ !empty($value_1->nilai_rujukan_pa) ? $value_1->nilai_rujukan_pa : ''  }}</td>
                                    <td class="py-3 border" ></td>
                                </tr>
                            @endforeach
                        @endif
