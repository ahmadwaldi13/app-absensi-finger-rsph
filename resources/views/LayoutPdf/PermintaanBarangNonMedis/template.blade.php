...
<table>
    ...
    <tr>
        <td colspan="2" style="text-align:justify">Untuk memenuhi kebutuhan Pengendali Medis pada Rumah Sakit Umum Daerah Kabupaten Aceh Tamiang, pada {{!empty($data->tanggal_pengajuan) ? $data->tanggal_pengajuan : '......................' }}, maka dengan ini kami mohon amprahan barang berupa:</td>
    </tr>
    <br>
    <tr >
        <td colspan="2" width="100%"  align="left">
            <table >
            @php
                // dd(!empty($data->nama_pgwai_inventori));
            @endphp
                <thead>
                    @if (isset($data->status_pgwai_inventori) && $data->status_pgwai_inventori == "2")

                        <tr align="center" >
                            <th width="5%" border="1" rowspan="2">No</th>
                            <th width="25%" border="1"rowspan="2">Nama Barang</th>
                            <th width="22%" border="1" colspan="2">Jumlah</th>
                            <th width="24%" border="1"rowspan="2">Keterangan Ruangan</th>
                            <th width="24%" border="1"rowspan="2">Keterangan Inventori</th>
                        </tr>
                        <tr align="center" valign="middle">
                            <th width="11%" border="1">Permintaan</th>
                            <th width="11%" border="1">Diberikan</th>
                        </tr>
                    @else
                        <tr align="center" >
                            <th width="5%" border="1" rowspan="2">No</th>
                            ...
                            <th width="30%" border="1"rowspan="2">Keterangan Ruangan</th>
                        </tr>
                        <tr align="center" valign="middle">
                    ...
                    @if (isset($data->status_pgwai_inventori) && $data->status_pgwai_inventori == "2")
                        @foreach ($data->list_data as $key => $value )
                            <tr>
                                ...
                                <td align="center" border="1"style="height:14px">{{!empty($value->keterangan_barang_keluar) ? $value->keterangan_barang_keluar :'' }}</td>
                            </tr>
                        @endforeach
                    @else
                        @foreach ($data->list_data as $key => $value )
    ...
    <br>
    <tr>
        <td colspan="2" style="text-align:justify">Demikianlah kami sampaikan untuk dapat dipertimbangkan selanjutnya dan terima kasih.</td>
    </tr>
    <br>
    {{-- <tr>
        <td  width="70%">
