...
namespace Resources\views\LayoutPdf\SPRI;

use App\Classes\ModulPDF;
/**
 * 
 */
class SPRI extends ModulPDF{
    ...
    protected static function model_1($instance, $data){
        ...
        $html = view('berkas-digital/klaim-berkas/berkas-list/spri/pasien_data', ["spri_data" => $data, "settings" => $instance->rs_settings_data, "is_pdf" => 1])->render();
