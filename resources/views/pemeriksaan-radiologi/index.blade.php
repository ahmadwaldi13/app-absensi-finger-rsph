...
@section('content')
    <div>
        @include('layouts.tab_lab',['active'=>3])
        <div class="card border-top-0 px-4 py-5">

            @include('pemeriksaan-radiologi.form')
    
            @include('pemeriksaan-radiologi.columns')
        </div>
    </div>
@endsection
...
@push('custom-script')
    ...
    <script src="{{ asset('js/pemeriksaan-radiologi/pemeriksaan_radiologi.js') }}"></script>
@endpush