...
<form id="formIsiResume" action="{{ url($action_form) }}" method="{{ !empty($method_form) ? $method_form : 'POST' }}">
    ...
    <div class="row justify-content-start align-items-end mb-3">
        <div class="col-lg-6 mb-3">
            <div class='bagan_form'>
                <label for="informasi_tambahan" class="form-label">Informasi tambahan permintaan foto</label>
        ...
        <div class="col-lg-6 mb-3">
            <div class='bagan_form'>
                <label for="indikasi" class="form-label">Indikasi pemeriksaan / diagnosa klinis <span class="text-danger">*</span></label>
