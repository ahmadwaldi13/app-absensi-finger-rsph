        ...
        <div class="card border-top-0 px-4 py-5">
            <div class="row d-flex align-items-end">
                ...
                <div class="col-xl-3 col-10 my-3">
                    ...
                    <input type="text" class="form-control input-daterange" id="daterangeRalan" placeholder="Masukkan Tanggal">
                        ...
                        <tr {{!empty($item['no_sep']) ?'style=background:#51a159;color:#fff;'  : '' }}>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>No. SEP</td>
                                        <td>: {{ !empty($item["no_sep"]) ? $item["no_sep"] : '-' }} </td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex flex-column justify-content-center">
                                    <div class="py-1 pe-4 text-primary" style="text-align: center;">
                                        <a href="{{ url('/') }}/berkas-digital/data-klaim?no_rawat={{ $item['no_rawat'] }}&no_rm={{ $item['no_rkm_medis'] }}&fr=rj"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="col-10 mx-3">
                                <div class="d-flex justify-content-center align-items-center border">
                                    <input type="text" class="form-control border-0" id="pencarianPoliklinik"
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td class="py-3"> <span class="text-primary hover-pointer"
                                                    onclick="setValue('{{ $poli }}', '{{ $name }}')">{{ $name }}</span>
                                            </td>
