...
@include('berkas-digital.klaim-berkas.berkas-kop') 
                <div class="section-header">
                    <p class="font-lg">RESUME PERAWATAN</p>
                </div>
                <div class="section-body" style="border:1px solid;">
                    @include("berkas-digital.klaim-berkas.berkas-list.resume.table_data")
                </div>
                ...
                <div class="section-footer text-end">
                    <div class="text-center d-inline-block page-break-inside-avoid">
                        ...
                        @if(!empty($resume_pasien->nm_dokter))
                            <div class="qrCode">
                                <?php $text = "DPJP: ".!empty($resume_pasien->nm_dokter) ? $resume_pasien->nm_dokter : "" ;?>
