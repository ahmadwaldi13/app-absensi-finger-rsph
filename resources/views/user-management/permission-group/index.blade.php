...
<form method="post" action="{{url('permission-group-app/update')}}" class="m-2 p-2 border rounded-3">
    ...
    <div class="d-flex justify-content-end align-items-center">
        ...
        <!-- <button type="submit" id="action"  class="btn btn-primary" data-whatever="@mdo" data-routes_ids="{{implode(',',$checked_permissions)}}" data-keterangan="{{$user_group->keterangan}}">
            Simpan
        </button> -->
...
<script>
    window.init_data = {
        routes_ids: "{{implode(',',$checked_permissions)}}".split(","),
        keterangan: "{{$user_group->keterangan}}",
        
    },
    window.alias="{{$user_group->alias}}"
</script>
