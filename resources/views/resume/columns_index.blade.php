...
<div style="overflow-x: auto; max-width: auto;">
    <table class="table border table-responsive-tablet">
        <thead>
            <tr>
                <th class="py-3" style="width: 8%">Tgl.Rawat</th>
                <th class="py-3" style="width: 7%;">No.Rawat</th>
                <th class="py-3" style="width: 20%;">Nama Pasien</th>
                <th class="py-3" style="width: 15%;">Dokter P.J</th>
                <th class="py-3" style="width: 2%;">Pulang</th>
                <th class="py-3" style="width: 20%;">Keluhan Utama</th>
                <th class="py-3" style="width: 15%;">Diagnosa Utama</th>
            ...
            @if(!empty($dataList))
                @foreach($dataList as $item)
                    ...
                    <tr>
                        ...
                        <td class="py-3">{{ !empty($item->kondisi_pulang) ? $item->kondisi_pulang : '' }}</td>
