...
<form action="{{url('/penilaian-perawat-psikiatri/update')}}" method="post" id="penilaian_perawat_psikiatri">
    @csrf
    <div class="row mb-3">
    ...
    <div>
        ...
        <div class="row align-items-end">
            ...
            <div class="col-6 mb-2">
                ...
                <textarea class="form-control" id="rkd_keluhan" name="rkd_keluhan" rows="3">{{!empty($penilaian->rkd_keluhan) ? $penilaian->rkd_keluhan : ''}}</textarea>
            </div>
            <div class="col-4 mb-2">
                <label for="rkd_sakit_sejak" class="form-label">Sakit Sejak</label>
                <input type="text" class="form-control w-75" name="rkd_sakit_sejak" id="rkd_sakit_sejak" value="{{!empty($penilaian->rkd_sakit_sejak) ? $penilaian->rkd_sakit_sejak : ''}}">
            </div>
            <div class="col-4 mb-2">
        ...
        <div class="row align-items-end">
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_putus_obat" id='ket_putus_obat' value="{{!empty($penilaian->ket_putus_obat) ? $penilaian->ket_putus_obat : ''}}">
                </div>
            </div>
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_masalah_ekonomi" id='ket_masalah_ekonomi' value="{{!empty($penilaian->ket_masalah_ekonomi) ? $penilaian->ket_masalah_ekonomi : ''}}">
                </div>
            </div>
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_masalah_fisik" id='ket_masalah_fisik' value="{{!empty($penilaian->ket_masalah_fisik) ? $penilaian->ket_masalah_fisik : ''}}">
                </div>
            </div>
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_masalah_psikososial" id='ket_masalah_psikososial' value="{{!empty($penilaian->ket_masalah_psikososial) ? $penilaian->ket_masalah_psikososial : ''}}">
                </div>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="row">
            ...
            <div class="col-6 mb-2">
                ...
                <input type="text" class="form-control" name="ket_rh_keluarga" id='ket_rh_keluarga' value="{{!empty($penilaian->ket_rh_keluarga) ? $penilaian->ket_rh_keluarga : ''}}">
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-5 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_rbd_ide" id='ket_rbd_ide' value="{{!empty($penilaian->ket_rbd_ide) ? $penilaian->ket_rbd_ide : ''}}">
                </div>
            </div>
            <div class="col-5 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_rbd_rencana" id='ket_rbd_rencana' value="{{!empty($penilaian->ket_rbd_rencana) ? $penilaian->ket_rbd_rencana : ''}}">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-5 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_rbd_alat" id='ket_rbd_alat' value="{{!empty($penilaian->ket_rbd_alat) ? $penilaian->ket_rbd_alat : ''}}">
                </div>
            </div>
            ...
            <div class="col-4 mb-2">
                ...
                <div class="d-flex">
                    <input type="text" class="form-control" name="ket_rbd_percobaan" id='ket_rbd_percobaan' value="{{!empty($penilaian->ket_rbd_percobaan) ? $penilaian->ket_rbd_percobaan : ''}}">
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-6 mb-2">
                ...
                <input type="text" class="form-control" name="ket_rbd_keinginan" id='ket_rbd_keinginan' value="{{!empty($penilaian->ket_rbd_keinginan) ? $penilaian->ket_rbd_keinginan : ''}}">
            </div>
        </div>
    </div>
    <hr class="mb-5">
        ...
        <div class="row mb-2">
            <div class="col">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_rpo_penggunaan" id='ket_rpo_penggunaan' value="{{!empty($penilaian->ket_rpo_penggunaan) ? $penilaian->ket_rpo_penggunaan : ''}}">
                </div>
            </div>
            <div class="col">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_penggunaan_obat_lainnya" id='ket_penggunaan_obat_lainnya' value="{{!empty($penilaian->ket_penggunaan_obat_lainnya) ? $penilaian->ket_penggunaan_obat_lainnya : ''}}">
                </div>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_rpo_efek_samping" id='ket_rpo_efek_samping' value="{{!empty($penilaian->ket_rpo_efek_samping) ? $penilaian->ket_rpo_efek_samping : ''}}">
                </div>
            </div>
            <div class="col">
                <label for="ket_alasan_penggunaan" class="form-label">Alasan Penggunaan : </label>
                <div class="d-flex">
                    <input type="text" class="form-control" name="ket_alasan_penggunaan" id='ket_alasan_penggunaan' value="{{!empty($penilaian->ket_alasan_penggunaan) ? $penilaian->ket_alasan_penggunaan : ''}}">
                </div>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_rpo_napza" id='ket_rpo_napza' value="{{!empty($penilaian->ket_rpo_napza) ? $penilaian->ket_rpo_napza : ''}}">
                </div>
            </div>
            <div class="col">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_alergi_obat" id='ket_alergi_obat' value="{{!empty($penilaian->ket_alergi_obat) ? $penilaian->ket_alergi_obat : ''}}">
                </div>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-3">
                ...
                <div class="d-flex">
                    <input type="text" class="form-control" name="ket_lama_pemakaian" id='ket_lama_pemakaian' value="{{!empty($penilaian->ket_lama_pemakaian) ? $penilaian->ket_lama_pemakaian : ''}}">
                </div>
            </div>
            <div class="col-3">
                <label for="ket_cara_pemakaian" class="form-label">Cara Pakai : </label>
                <div class="d-flex">
                    <input type="text" class="form-control" name="ket_cara_pemakaian" id='ket_cara_pemakaian' value="{{!empty($penilaian->ket_cara_pemakaian) ? $penilaian->ket_cara_pemakaian : ''}}">
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-50" name="ket_merokok" id='ket_merokok' value="{{!empty($penilaian->ket_merokok) ? $penilaian->ket_merokok : ''}}"><span class="mt-2">Batang/Hari</span>
                </div>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-6">
                ...
                <div class="d-flex">
                    <input type="text" class="form-control" name="ket_latar_belakang_pemakaian" id='ket_latar_belakang_pemakaian' value="{{!empty($penilaian->ket_latar_belakang_pemakaian) ? $penilaian->ket_latar_belakang_pemakaian : ''}}">
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-50" name="ket_minum_kopi" id='ket_minum_kopi' value="{{!empty($penilaian->ket_minum_kopi) ? $penilaian->ket_minum_kopi : ''}}"><span class="mt-2">Gelas/Hari</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row  mb-2">
            <div class="col">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" class="form-control w-75" name="ket_keluhan_fisik" id='ket_keluhan_fisik' value="{{!empty($penilaian->ket_keluhan_fisik) ? $penilaian->ket_keluhan_fisik : ''}}">
                </div>
            </div>
        </div>
        <div class="row  mb-2">
            ...
            <div class="col-3">
                ...
                <div class="input-group">
                    <input type="text" id="gcs" name="gcs" class="form-control" value="{{!empty($penilaian->gcs) ? $penilaian->gcs : ''}}">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-2">
            <div class="col-5">
                ...
                <div class="mt-5">
                    ...
                    <div class="d-flex">
                        ...
                        <input type="text" class="form-control w-75" name="ket_nyeri" id='ket_nyeri' value="{{!empty($penilaian->ket_nyeri) ? $penilaian->ket_nyeri : ''}}">
                    </div>
                </div>
            </div>
            <div class="col-7">
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <div class="d-flex">
                            ...
                            <input type="text" class="form-control w-75" name="ket_provokes" id='ket_provokes' value="{{!empty($penilaian->ket_provokes) ? $penilaian->ket_provokes : ''}}">
                        </div>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col">
                        ...
                        <div class="d-flex">
                            ...
                            <input type="text" class="form-control w-75" name="ket_quality" id='ket_quality' value="{{!empty($penilaian->ket_quality) ? $penilaian->ket_quality : ''}}">
                        </div>
                    </div>
                </div>
                <div class="row mb-2">
                    ...
                    <div class="col-6">
                        ...
                        <div class="d-flex">
                            <input type="text" class="form-control" name="lokasi" id='lokasi' value="{{!empty($penilaian->lokasi) ? $penilaian->lokasi : ''}}">
                        </div>
                </div>
                <div class="col-6">
            ...
            <div class="row mb-2">
                ...
                <div class="col">
                    ...
                    <div class="input-group">
                        <input type="text" id="durasi" name="durasi" class="form-control" value="{{!empty($penilaian->durasi) ? $penilaian->durasi : ''}}">
            ...
            <div class="row mb-2">
                ...
                <div class="col">
                    ...
                    <div class="input-group">
                        <input type="text" id="ket_dokter" name="ket_dokter" class="form-control" value="{{!empty($penilaian->ket_dokter) ? $penilaian->ket_dokter : ''}}">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div>
        ...
        <div class="row mb-2">
            <div class="col-2">
                ...
                <div class="input-group">
                    <input type="text" id="bb" name="bb" class="form-control" value="{{!empty($penilaian->bb) ? $penilaian->bb : ''}}">
            ...
            <div class="col-2">
                ...
                <div class="input-group">
                    <input type="text" id="tb" name="tb" class="form-control" value="{{!empty($penilaian->tb) ? $penilaian->tb : ''}}">
            ...
            <div class="col-2">
                ...
                <div class="input-group">
                    <input type="text" id="bmi" name="bmi" class="form-control" value="{{!empty($penilaian->bmi) ? $penilaian->bmi : ''}}">
            ...
            <div class="col-3">
                ...
                <div class="input-group">
                    <input type="text" id="ket_lapor_status_nutrisi" name="ket_lapor_status_nutrisi" class="form-control" value="{{!empty($penilaian->ket_lapor_status_nutrisi) ? $penilaian->ket_lapor_status_nutrisi : ''}}">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row position-relative">
            <div class="col-5 position-absolute top-0 end-0">
                <div class="d-flex">
                    ...
                    <div class="input-group">
                        <input type="text" id="total_hasil" name="total_hasil" class="form-control" value="{{!empty($penilaian->total_hasil) ? $penilaian->total_hasil : ''}}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row ">
            ...
            <div class="col-3">
                <div class="d-flex">
                    ...
                    <input type="text" id="ket_lapor" name="ket_lapor" class="form-control w-50" value="{{!empty($penilaian->ket_lapor) ? $penilaian->ket_lapor : ''}}">
                </div>
            </div>
        </div>
    </div>
       ...
       <div class="row mb-2 mt-2">
        ...
        <div class="col-6">
            <div class="d-flex">
                ...
                <input type="text" id="ket_adl_sosialisasi" name="ket_adl_sosialisasi" class="form-control w-50 ms-1" value="{{!empty($penilaian->ket_adl_sosialisasi) ? $penilaian->ket_adl_sosialisasi : ''}}">
            </div>
        </div>
        <div class="col-3">
            <div class="d-flex">
       ...
       <div class="row mb-2">
        ...
        <div class="col-6">
            <div class="d-flex">
                ...
                <input type="text" id="ket_adl_hobi" name="ket_adl_hobi" class="form-control w-50 ms-1" value="{{!empty($penilaian->ket_adl_hobi) ? $penilaian->ket_adl_hobi : ''}} ">
            </div>
        </div>
        <div class="col-3">
            <div class="d-flex">
       ...
       <div class="row mb-2">
        ...
        <div class="col-6">
            <div class="d-flex">
                ...
                <input type="text" id="ket_adl_kegiatan" name="ket_adl_kegiatan" class="form-control w-50 ms-1" value="{{!empty($penilaian->ket_adl_kegiatan) ? $penilaian->ket_adl_kegiatan : ''}}">
            </div>
        </div>
       </div>
    </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-7">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" id="ket_sk_daya_tilik_diri" name="ket_sk_daya_tilik_diri" class="form-control w-100 ms-1" value="{{!empty($penilaian->ket_sk_daya_tilik_diri) ? $penilaian->ket_sk_daya_tilik_diri : ''}} ">
                </div>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-6">
                ...
                <div class="d-flex">
                    <select class="form-select" id="sk_memori"  name="sk_memori" aria-label="Default select example">
                        ...
                        <option value="Konfabulasi" {{$penilaian->sk_memori === "Konfabulasi" ? 'selected' : ''}}>Konfabulasi</option>
        ...
        <div class="row mb-2">
            <div class="col-6">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" id="ket_sk_persepsi" name="ket_sk_persepsi" class="form-control ms-1" value="{{!empty($penilaian->ket_sk_persepsi) ? $penilaian->ket_sk_persepsi : ''}} ">
                </div>
            </div>
            <div class="col-6">
        ...
        <div class="row mb-2">
            ...
            <div class="col-6">
                ...
                <div class="d-flex">
                    ...
                    <input type="text" id="ket_sk_waham" name="ket_sk_waham" class="form-control ms-1" value="{{!empty($penilaian->ket_sk_waham) ? $penilaian->ket_sk_waham : ''}}">
                </div>
            </div>
            <div class="col-3">
    ...
    <div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-2">
                <span>Lainnya :</span>
                <input type="text" id="ket_kk_pembelajaran_lainnya" name="ket_kk_pembelajaran_lainnya" class="form-control ms-1 w-100" value="{{!empty($penilaian->ket_kk_pembelajaran_lainnya) ? $penilaian->ket_kk_pembelajaran_lainnya : ''}}">
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-8 mt-4">
                <div class="d-flex">
                    ...
                    <span class="mt-2">Jika, ya:</span>
                    <input type="text" id="ket_kk_penerjamah_Lainnya" name="ket_kk_penerjamah_Lainnya" class="form-control ms-1 w-25" value="{{!empty($penilaian->ket_kk_penerjamah_Lainnya) ? $penilaian->ket_kk_penerjamah_Lainnya : ''}}">
                </div>
            </div>
            <div class="col-4">
                <span>Lainnya :</span>
        ...
        <div class="row mb-2 mt-4">
            ...
            <div class="col-6">
                ...
                <div class="d-flex">
                    <input type="text" class="form-control" name="ket_kk_kebutuhan_edukasi" id='ket_kk_kebutuhan_edukasi' value="{{!empty($penilaian->ket_kk_kebutuhan_edukasi) ? $penilaian->ket_kk_kebutuhan_edukasi : ''}}">
                </div>
            </div>
        </div>
        <hr class="mb-5">
