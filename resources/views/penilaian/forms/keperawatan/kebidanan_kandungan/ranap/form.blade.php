...
<div>
    ...
    <div class="row align-items-end">
        <div class="col-6 mb-2">
            ...
            <textarea  class="form-control" id="keluhan" name="keluhan" rows="3">{{!empty($penilaian->keluhan) ? $penilaian->keluhan : ''}}</textarea>
        </div>
        <div class="col-6 mb-2">
        ...
        <div class="col-6 mb-2">
            ...
            <textarea  class="form-control" id="psk" name="psk" rows="3">{{!empty($penilaian->psk) ? $penilaian->psk : ''}}</textarea>
        </div>
        <div class="col-6 mb-2">
            <label for="rp" class="form-label">Riwayat Pembedahan</label>
            <textarea  class="form-control" id="rp" name="rp" rows="3">{{!empty($penilaian->rp) ? $penilaian->rp : ''}}</textarea>
        </div>
        <div class="col-6 mb-2 ">
        ...
        <div class="col mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select w-25" id="komplikasi_sebelumnya"  name="komplikasi_sebelumnya" aria-label="Default select example">
                ...
                <input  type="text" class="form-control w-75" name="keterangan_komplikasi_sebelumnya" value="{{!empty($penilaian->keterangan_komplikasi_sebelumnya) ? $penilaian->keterangan_komplikasi_sebelumnya : ''}}" id='keterangan_komplikasi_sebelumnya' value="">
            </div>
        ...
        <div class="ms-2 row">
            <div class="col-4 mb-2">
                ...
                <div class="input-group  me-2">
                    <input   type="text" id="riwayat_mens_umur" name="riwayat_mens_umur" value="{{!empty($penilaian->riwayat_mens_umur) ? $penilaian->riwayat_mens_umur : ''}}"   class="form-control">
            ...
            <div class="col-4 mb-2">
                ...
                <div class="input-group  me-2">
                    <input   type="text" id="riwayat_mens_lamanya" name="riwayat_mens_lamanya" value="{{!empty($penilaian->riwayat_mens_lamanya) ? $penilaian->riwayat_mens_lamanya : ''}}"   class="form-control">
            ...
            <div class="col-4 mb-2">
                ...
                <div class="input-group  me-2">
                    <input   type="text" id="riwayat_mens_banyaknya" name="riwayat_mens_banyaknya" value="{{!empty($penilaian->riwayat_mens_banyaknya) ? $penilaian->riwayat_mens_banyaknya : ''}}"   class="form-control">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <div class="input-group  me-2">
                        <input   type="text" id="riwayat_mens_siklus" name="riwayat_mens_siklus" value="{{!empty($penilaian->riwayat_mens_siklus) ? $penilaian->riwayat_mens_siklus : ''}}"   class="form-control">
                        <span class="input-group-text">hari</span>
                    </div>,
                    <select  class="form-select me-2" id="riwayat_mens_siklus"  name="riwayat_mens_siklus" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <select  class="form-select me-2" id="riwayat_mens_dirasakan"  name="riwayat_mens_dirasakan" aria-label="Default select example">
        ...
        <div class="ms-2 row">
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select w-75 me-2" id="riwayat_perkawinan_status"  name="riwayat_perkawinan_status" aria-label="Default select example">
                    ...
                    <div class="input-group  w-25 me-2">
                        <input   type="text" id="riwayat_perkawinan_ket_status" name="riwayat_perkawinan_ket_status" value="{{!empty($penilaian->riwayat_perkawinan_ket_status) ? $penilaian->riwayat_perkawinan_ket_status : ''}}"   class="form-control">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex align-items-center">
                    <div class="input-group  w-25 me-2">
                        <input   type="text" id="riwayat_perkawinan_usia1" name="riwayat_perkawinan_usia1" value="{{!empty($penilaian->riwayat_perkawinan_usia1) ? $penilaian->riwayat_perkawinan_usia1 : ''}}"   class="form-control">
                        <span class="input-group-text">kali</span>
                    </div>
                    <span class="mx-1">, Status: </span>
                    <select  class="form-select w-50 me-2" id="riwayat_perkawinan_ket_usia1"  name="riwayat_perkawinan_ket_usia1" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex align-items-center">
                    <div class="input-group  w-25 me-2">
                        <input   type="text" id="riwayat_perkawinan_usia2" name="riwayat_perkawinan_usia2" value="{{!empty($penilaian->riwayat_perkawinan_usia2) ? $penilaian->riwayat_perkawinan_usia2 : ''}}"   class="form-control">
                        <span class="input-group-text">kali</span>
                    </div>
                    <span class="mx-1">, Status: </span>
                    <select  class="form-select w-50 me-2" id="riwayat_perkawinan_ket_usia2"  name="riwayat_perkawinan_ket_usia2" aria-label="Default select example">
                        @foreach (['-','Masih Menikah','Cerai','Meninggal'] as $item)
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex align-items-center">
                    <div class="input-group  w-25 me-2">
                        <input   type="text" id="riwayat_perkawinan_usia3" name="riwayat_perkawinan_usia3" value="{{!empty($penilaian->riwayat_perkawinan_usia3) ? $penilaian->riwayat_perkawinan_usia3 : ''}}"   class="form-control">
                        <span class="input-group-text">kali</span>
                    </div>
                    <span class="mx-1">, Status: </span>
                    <select  class="form-select w-50 me-2" id="riwayat_perkawinan_ket_usia3"  name="riwayat_perkawinan_ket_usia3" aria-label="Default select example">
                        @foreach (['-','Masih Menikah','Cerai','Meninggal'] as $item)
        ...
        <div class="ms-2 row">
            <div class="col-3 mb-2">
                ...
                <input id="riwayat_persalinan_g" name="riwayat_persalinan_g" value="{{!empty($penilaian->riwayat_persalinan_g) ? $penilaian->riwayat_persalinan_g : ''}}" type="text" class="form-control">
            </div>
            <div class="col-3 mb-2">
                <label for="riwayat_persalinan_p" class="form-label">P:</label>
                <input id="riwayat_persalinan_p" name="riwayat_persalinan_p" value="{{!empty($penilaian->riwayat_persalinan_p) ? $penilaian->riwayat_persalinan_p : ''}}" type="text" class="form-control">
            </div>
            <div class="col-3 mb-2">
                <label for="riwayat_persalinan_a" class="form-label">A:</label>
                <input id="riwayat_persalinan_a" name="riwayat_persalinan_a" value="{{!empty($penilaian->riwayat_persalinan_a) ? $penilaian->riwayat_persalinan_a : ''}}" type="text" class="form-control">
            </div>
            <div class="col-3 mb-2">
                <label for="riwayat_persalinan_hidup" class="form-label">Anak Yang Hidup:</label>
                <input id="riwayat_persalinan_hidup" name="riwayat_persalinan_hidup" value="{{!empty($penilaian->riwayat_persalinan_hidup) ? $penilaian->riwayat_persalinan_hidup : ''}}" type="text" class="form-control">
            </div>
        ...
        <div class="ms-2 row">
            <div class="col-3 mb-2">
                ...
                <input  type="text" class="form-control input-daterange input-date-time" name="riwayat_hamil_hpht" value="{{!empty($penilaian->riwayat_hamil_hpht) ? $penilaian->riwayat_hamil_hpht : ''}}" id="riwayat_hamil_hpht"  required autocomplete="off" >
            </div>
            <div class="col-3 mb-2">
                <label for="riwayat_hamil_usiahamil" class="form-label">Usia Hamil :</label>
                <div class="input-group">
                    <input  type="text" name="riwayat_hamil_usiahamil" value="{{!empty($penilaian->riwayat_hamil_usiahamil) ? $penilaian->riwayat_hamil_usiahamil : ''}}" id="riwayat_hamil_usiahamil" class="form-control">
                    <span class="input-group-text" id="ModalPetugas">bln/mgg</span>
                </div>
            </div>
            <div class="col-3 mb-2">
                <label for="riwayat_hamil_tp" class="form-label">TP :</label>
                <input  type="text" class="form-control input-daterange input-date-time" name="riwayat_hamil_tp" value="{{!empty($penilaian->riwayat_hamil_tp) ? $penilaian->riwayat_hamil_tp : ''}}" id="riwayat_hamil_tp"  required autocomplete="off" >
            </div>
            <div class="col-3 mb-2">
                <label for="riwayat_hamil_imunisasi" class="form-label">Riwayat Imunisasi : </label>
                <select  class="form-select" id="riwayat_hamil_imunisasi" name="riwayat_hamil_tp" ariaimunisasi="Default select ">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="input-group">
                    <input  type="text" name="riwayat_hamil_anc" value="{{!empty($penilaian->riwayat_hamil_anc) ? $penilaian->riwayat_hamil_anc : ''}}" id="riwayat_hamil_anc" class="form-control">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <input   placeholder="Keterangan" type="text" id="riwayat_hamil_ancke" name="riwayat_hamil_ancke" value="{{!empty($penilaian->riwayat_hamil_ancke) ? $penilaian->riwayat_hamil_ancke : ''}}"   class="form-control">
                    <select  class="form-select me-2" id="riwayat_hamil_ancke"  name="riwayat_hamil_ancke" aria-labe="Default select example">
                        @foreach(['Teratur','Tidak Teratur'] as $item)
            ...
            <div class="col-3 mb-2">
                ...
                <select  class="form-select" id="riwayat_hamil_keluhan_hamil_muda" name="riwayat_hamil_keluhan_hamil_muda" aria-label="Default select ">
            ...
            <div class="col-3 mb-2">
                ...
                <select  class="form-select" id="riwayat_hamil_keluhan_hamil_tua" name="riwayat_hamil_keluhan_hamil_tua" aria-label="Default select ">
                    @foreach (['Tidak Ada','Mual','Muntah','Perdarahan','Lain–lain'] as $item)
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex align-items-center">
                    <select  class="form-select me-2" id="riwayat_kb"  name="riwayat_kb" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="riwayat_kb_lamanya" name="riwayat_kb_lamanya" value="{{!empty($penilaian->riwayat_kb_lamanya) ? $penilaian->riwayat_kb_lamanya : ''}}"   class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
                <label for="riwayat_kb_komplikasi" class="form-label">Komplikasi : </label>
                <div class="d-flex ">
                    <input   placeholder="Keterangan" type="text" id="riwayat_kb_komplikasi" name="riwayat_kb_komplikasi" value="{{!empty($penilaian->riwayat_kb_komplikasi) ? $penilaian->riwayat_kb_komplikasi : ''}}"   class="form-control">
                    <select  class="form-select w-75 me-2" id="riwayat_kb_ket_komplikasi"  name="riwayat_kb_ket_komplikasi" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <input id="riwayat_kb_kapaberhenti" name="riwayat_kb_kapaberhenti" value="{{!empty($penilaian->riwayat_kb_kapaberhenti) ? $penilaian->riwayat_kb_kapaberhenti : ''}}" type="text" class="form-control">
            </div>
            <div class="col-3 mb-2">
                <label for="riwayat_kb_alasanberhenti" class="form-label">Alasan:</label>
                <input id="riwayat_kb_alasanberhenti" name="riwayat_kb_alasanberhenti" value="{{!empty($penilaian->riwayat_kb_alasanberhenti) ? $penilaian->riwayat_kb_alasanberhenti : ''}}" type="text" class="form-control">
            </div>
            <div class="col-6 mb-2">
                <label for="riwayat_genekologi" class="form-label">Riwayat Ginekologi : </label>
                <select  class="form-select w-75 me-2" id="riwayat_genekologi"  name="riwayat_genekologi" aria-label="Default select example">
        ...
        <div class="ms-2 row">
            <div class="col-12 mb-2">
                ...
                <div class="d-flex ">
                    <select  class="form-select w-75 me-2" id="riwayat_kebiasaan_obat"  name="riwayat_kebiasaan_obat" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="riwayat_kebiasaan_ket_obat" name="riwayat_kebiasaan_ket_obat" value="{{!empty($penilaian->riwayat_kebiasaan_ket_obat) ? $penilaian->riwayat_kebiasaan_ket_obat : ''}}""   class="form-control">
                </div>
            </div>
            ...
            <div class="col-4 mb-2">
                ...
                <div class="d-flex ">
                    <select  class="form-select w-75 me-2" id="riwayat_kebiasaan_merokok"  name="riwayat_kebiasaan_merokok" aria-label="Default select example">
                        @foreach(['Tidak','Ya'] as $item)
                    ...
                    <div class="input-group">
                        <input  type="text" name="riwayat_kebiasaan_ket_merokok" value="{{!empty($penilaian->riwayat_kebiasaan_ket_merokok) ? $penilaian->riwayat_kebiasaan_ket_merokok : ''}}" id="riwayat_kebiasaan_ket_merokok" class="form-control">
            ...
            <div class="col-4 mb-2">
                ...
                <div class="d-flex ">
                    <select  class="form-select me-2" id="riwayat_kebiasaan_alkohol"  name="riwayat_kebiasaan_alkohol" aria-label="Default select example">
                        @foreach(['Tidak','Ya'] as $item)
                ...
                <div class="input-group">
                    <input  type="text" name="riwayat_kebiasaan_ket_alkohol" value="{{!empty($penilaian->riwayat_kebiasaan_ket_alkohol) ? $penilaian->riwayat_kebiasaan_ket_alkohol : ''}}" id="riwayat_kebiasaan_ket_merokok" class="form-control">
                    <span class="input-group-text" id="ModalPetugas">batang/hari</span>
                </div>
            </div>
            <div class="col-4 mb-2">
                ...
                <div class="d-flex ">
                    <select  class="form-select me-2" id="riwayat_kebiasaan_narkoba"  name="riwayat_kebiasaan_narkoba" aria-label="Default select example">
                        @foreach(['Tidak','Ya'] as $item)
...
<div>
    ...
    <div class="row align-items-end">
        <div class="col-3 mb-2">
            ...
            <input  type="text" name="pemeriksaan_kebidanan_mental" value="{{!empty($penilaian->pemeriksaan_kebidanan_mental) ? $penilaian->pemeriksaan_kebidanan_mental : ''}}" id="pemeriksaan_kebidanan_mental" class="form-control">
        </div>
        <div class="col-3 mb-2">
            <label for="pemeriksaan_kebidanan_keadaan_umum" class="form-label">keadaan Umum : </label>
            <select  class="form-select" id="pemeriksaan_kebidanan_keadaan_umum" name="pemeriksaan_kebidanan_keadaan_umum" keadaan_umumaria-label="Default select ">
        ...
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" name="pemeriksaan_kebidanan_td" value="{{!empty($penilaian->pemeriksaan_kebidanan_td) ? $penilaian->pemeriksaan_kebidanan_td : ''}}" id="pemeriksaan_kebidanan_td" class="form-control">
        ...
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_nadi" name="pemeriksaan_kebidanan_nadi" value="{{!empty($penilaian->pemeriksaan_kebidanan_nadi) ? $penilaian->pemeriksaan_kebidanan_nadi : ''}}" class="form-control">
        ...
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_rr" name="pemeriksaan_kebidanan_rr" value="{{!empty($penilaian->pemeriksaan_kebidanan_rr) ? $penilaian->pemeriksaan_kebidanan_rr : ''}}" class="form-control">
                <span class="input-group-text" id="ModalPetugas">x / Menit</span>
            </div>
        </div>
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_suhu" name="pemeriksaan_kebidanan_suhu" value="{{!empty($penilaian->pemeriksaan_kebidanan_suhu) ? $penilaian->pemeriksaan_kebidanan_suhu : ''}}" class="form-control">
        ...
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_gcs" name="pemeriksaan_kebidanan_gcs" value="{{!empty($penilaian->pemeriksaan_kebidanan_gcs) ? $penilaian->pemeriksaan_kebidanan_gcs : ''}}" class="form-control">
            </div>
        </div>
        <div class="col-3 mb-2">
            <label for="pemeriksaan_kebidanan_bb" class="form-label">BB : </label>
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_bb" name="pemeriksaan_kebidanan_bb" value="{{!empty($penilaian->pemeriksaan_kebidanan_bb) ? $penilaian->pemeriksaan_kebidanan_bb : ''}}" class="form-control">
        ...
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_tb" name="pemeriksaan_kebidanan_tb" value="{{!empty($penilaian->pemeriksaan_kebidanan_tb) ? $penilaian->pemeriksaan_kebidanan_tb : ''}}" class="form-control">
        ...
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_spo2" name="pemeriksaan_kebidanan_spo2" value="{{!empty($penilaian->pemeriksaan_kebidanan_spo2) ? $penilaian->pemeriksaan_kebidanan_spo2 : ''}}" class="form-control">
                <span class="input-group-text" id="ModalPetugas">%</span>
            </div>
        </div>
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_lila" name="pemeriksaan_kebidanan_lila" value="{{!empty($penilaian->pemeriksaan_kebidanan_lila) ? $penilaian->pemeriksaan_kebidanan_lila : ''}}" class="form-control">
                <span class="input-group-text" id="ModalPetugas">cm</span>
            </div>
        </div>
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_tfu" name="pemeriksaan_kebidanan_tfu" value="{{!empty($penilaian->pemeriksaan_kebidanan_tfu) ? $penilaian->pemeriksaan_kebidanan_tfu : ''}}" class="form-control">
                <span class="input-group-text" id="ModalPetugas">cm</span>
            </div>
        </div>
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_tbj" name="pemeriksaan_kebidanan_tbj" value="{{!empty($penilaian->pemeriksaan_kebidanan_tbj) ? $penilaian->pemeriksaan_kebidanan_tbj : ''}}" class="form-control">
                <span class="input-group-text" id="ModalPetugas">gr</span>
            </div>
        </div>
        <div class="col-3 mb-2">
            <label for="" class="form-label"> GD: </label>
            <input  type="text" id="" name="" class="form-control" value="{{!empty($penilaian->class) ? $penilaian->class : ''}}">
        </div>
        <div class="col-3 mb-2">
            <label for="pemeriksaan_kebidanan_letak" class="form-label"> Letak: </label>
            <input  type="text" id="pemeriksaan_kebidanan_letak" name="pemeriksaan_kebidanan_letak" value="{{!empty($penilaian->pemeriksaan_kebidanan_letak) ? $penilaian->pemeriksaan_kebidanan_letak : ''}}" class="form-control">
        </div>
        <div class="col-3 mb-2">
            <label for="pemeriksaan_kebidanan_presentasi" class="form-label"> Presentasi: </label>
            <input  type="text" id="pemeriksaan_kebidanan_presentasi" name="pemeriksaan_kebidanan_presentasi" value="{{!empty($penilaian->pemeriksaan_kebidanan_presentasi) ? $penilaian->pemeriksaan_kebidanan_presentasi : ''}}" class="form-control">
        </div>
        <div class="col-3 mb-2">
            <label for="pemeriksaan_kebidanan_penurunan" class="form-label"> Penurunan: </label>
            <input  type="text" id="pemeriksaan_kebidanan_penurunan" name="pemeriksaan_kebidanan_penurunan" value="{{!empty($penilaian->pemeriksaan_kebidanan_penurunan) ? $penilaian->pemeriksaan_kebidanan_penurunan : ''}}" class="form-control">
        </div>
        <div class="col-3 mb-2">
            <label for="pemeriksaan_kebidanan_his" class="form-label"> Kontraksi/HIS: </label>
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_his" name="pemeriksaan_kebidanan_his" value="{{!empty($penilaian->pemeriksaan_kebidanan_his) ? $penilaian->pemeriksaan_kebidanan_his : ''}}" class="form-control">
        ...
        <div class="col-3 mb-2">
            ...
            <input  type="text" id="pemeriksaan_kebidanan_kekuatan" name="pemeriksaan_kebidanan_kekuatan" value="{{!empty($penilaian->pemeriksaan_kebidanan_kekuatan) ? $penilaian->pemeriksaan_kebidanan_kekuatan : ''}}" class="form-control">
        </div>
        <div class="col-3 mb-2">
            <label for="pemeriksaan_kebidanan_lamanya" class="form-label"> Lamanya: </label>
            <input  type="text" id="pemeriksaan_kebidanan_lamanya" name="pemeriksaan_kebidanan_lamanya" value="{{!empty($penilaian->pemeriksaan_kebidanan_lamanya) ? $penilaian->pemeriksaan_kebidanan_lamanya : ''}}" class="form-control">
        </div>
        <div class="col-6 mb-2">
            <label for="pemeriksaan_kebidanan_djj" class="form-label"> Gerak janin x/30 menit, DJJ: </label>
            <div class="d-flex">
                <div class="input-group">
                    <input  type="text" id="pemeriksaan_kebidanan_djj" name="pemeriksaan_kebidanan_djj" value="{{!empty($penilaian->pemeriksaan_kebidanan_djj) ? $penilaian->pemeriksaan_kebidanan_djj : ''}}" class="form-control">
                    <span class="input-group-text" id="ModalPetugas">/mnt</span>
                </div>
                <select  class="form-select mx-2" id=""  name="" aria-label="Default select example">
                    @foreach (['Teratur','Tidak Teratur'] as $item)
        ...
        <div class="col-3 mb-2">
            ...
            <input  type="text" id="pemeriksaan_kebidanan_portio" name="pemeriksaan_kebidanan_portio" value="{{!empty($penilaian->pemeriksaan_kebidanan_portio) ? $penilaian->pemeriksaan_kebidanan_portio : ''}}" class="form-control">
        </div>
        <div class="col-3 mb-2">
            <label for="pemeriksaan_kebidanan_pembukaan" class="form-label"> Pembukaan Serviks : </label>
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_pembukaan" name="pemeriksaan_kebidanan_pembukaan" value="{{!empty($penilaian->pemeriksaan_kebidanan_pembukaan) ? $penilaian->pemeriksaan_kebidanan_pembukaan : ''}}" class="form-control">
                <span class="input-group-text" id="ModalPetugas">cm</span>
            </div>
        </div>
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input  type="text" id="pemeriksaan_kebidanan_ketuban" name="pemeriksaan_kebidanan_ketuban" value="{{!empty($penilaian->pemeriksaan_kebidanan_ketuban) ? $penilaian->pemeriksaan_kebidanan_ketuban : ''}}" class="form-control">
        ...
        <div class="col-3 mb-2">
            ...
            <input  type="text" id="pemeriksaan_kebidanan_hodge" name="pemeriksaan_kebidanan_hodge" value="{{!empty($penilaian->pemeriksaan_kebidanan_hodge) ? $penilaian->pemeriksaan_kebidanan_hodge : ''}}" class="form-control">
        </div>

        <div class="col-3 mb-2">
            <label for="pemeriksaan_kebidanan_panggul" class="form-label"> Panggul: </label>
            <select  class="form-select me-2" id="pemeriksaan_kebidanan_panggul"  name="pemeriksaan_kebidanan_panggul" aria-label="Default select example">
        ...
        <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_kebidanan_inspekulo"  name="pemeriksaan_kebidanan_inspekulo" aria-label="Default select example">
                    @foreach (['Dilakukan','Tidak'] as $item)
                ...
                <input  type="text" id="pemeriksaan_kebidanan_ket_inspekulo" name="pemeriksaan_kebidanan_ket_inspekulo" value="{{!empty($penilaian->pemeriksaan_kebidanan_ket_inspekulo) ? $penilaian->pemeriksaan_kebidanan_ket_inspekulo : ''}}" class="form-control">
            </div>
        </div>
        <div class="col-6 mb-2">
            <label for="pemeriksaan_kebidanan_lakmus" class="form-label"> Lakmus: </label>
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_kebidanan_lakmus"  name="pemeriksaan_kebidanan_lakmus" aria-label="Default select example">
                    @foreach (['Dilakukan','Tidak'] as $item)
                ...
                <input  type="text" id="pemeriksaan_kebidanan_ket_lakmus" name="pemeriksaan_kebidanan_ket_lakmus" value="{{!empty($penilaian->pemeriksaan_kebidanan_ket_lakmus) ? $penilaian->pemeriksaan_kebidanan_ket_lakmus : ''}}" class="form-control">
            </div>
        </div>
        ...
        <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_kebidanan_ctg"  name="pemeriksaan_kebidanan_ctg" aria-label="Default select example">
                    @foreach (['Dilakukan','Tidak'] as $item)
                ...
                <input  type="text" id="pemeriksaan_kebidanan_ket_ctg" name="pemeriksaan_kebidanan_ket_ctg" value="{{!empty($penilaian->pemeriksaan_kebidanan_ket_ctg) ? $penilaian->pemeriksaan_kebidanan_ket_ctg : ''}}" class="form-control">
            </div>
        </div>
...
<div>
    ...
    <div class="row">
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_kepala"  name="pemeriksaan_umum_kepala" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_muka"  name="pemeriksaan_umum_muka" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_mata"  name="pemeriksaan_umum_mata" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_hidung"  name="pemeriksaan_umum_hidung" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_telinga"  name="pemeriksaan_umum_telinga" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_mulut"  name="pemeriksaan_umum_mulut" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_leher"  name="pemeriksaan_umum_leher" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_dada"  name="pemeriksaan_umum_dada" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_perut"  name="pemeriksaan_umum_perut" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_genitalia"  name="pemeriksaan_umum_genitalia" aria-label="Default select example">
        ...
        <div class="col-4 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pemeriksaan_umum_ekstrimitas"  name="pemeriksaan_umum_ekstrimitas" aria-label="Default select example">
...
<div>
    ...
    <div class="row">
       <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="pengkajian_fungsi_kemampuan_aktifitas"  name="pengkajian_fungsi_kemampuan_aktifitas" aria-label="Default select example">
       ...
       <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                ...
                <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_ket_berjalan" name="pengkajian_fungsi_ket_berjalan" value="{{!empty($penilaian->pengkajian_fungsi_ket_berjalan) ? $penilaian->pengkajian_fungsi_ket_berjalan : ''}}"   class="form-control">
            </div>
        </div>
       <div class="col-6 mb-2">
            <label for="pengkajian_fungsi_aktivitas" class="form-label">c. Aktivitas : </label>
            <div class="d-flex">
                <select  class="form-select me-2" id="pengkajian_fungsi_aktivitas"  name="pengkajian_fungsi_aktivitas" aria-label="Default select example">
       ...
       <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                ...
                <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_ket_ekstrimitas_atas" name="pengkajian_fungsi_ket_ekstrimitas_atas" value="{{!empty($penilaian->pengkajian_fungsi_ket_ekstrimitas_atas) ? $penilaian->pengkajian_fungsi_ket_ekstrimitas_atas : ''}}"   class="form-control">
            </div>
        </div>
       <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                ...
                <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_ket_ekstrimitas_bawah" name="pengkajian_fungsi_ket_ekstrimitas_bawah" value="{{!empty($penilaian->pengkajian_fungsi_ket_ekstrimitas_bawah) ? $penilaian->pengkajian_fungsi_ket_ekstrimitas_bawah : ''}}"   class="form-control">
            </div>
        </div>
       <div class="col-6 mb-2">
            <label for="pengkajian_fungsi_kemampuan_menggenggam" class="form-label">g. Kemampuan Menggenggam : </label>
            <div class="d-flex">
                <select  class="form-select me-2" id="pengkajian_fungsi_kemampuan_menggenggam"  name="pengkajian_fungsi_kemampuan_menggenggam" aria-label="Default select example">
                ...
                <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_ket_kemampuan_menggenggam" name="pengkajian_fungsi_ket_kemampuan_menggenggam" value="{{!empty($penilaian->pengkajian_fungsi_ket_kemampuan_menggenggam) ? $penilaian->pengkajian_fungsi_ket_kemampuan_menggenggam : ''}}"   class="form-control">
            </div>
        </div>
       <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                ...
                <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_ket_koordinasi" name="pengkajian_fungsi_ket_koordinasi" value="{{!empty($penilaian->pengkajian_fungsi_ket_koordinasi) ? $penilaian->pengkajian_fungsi_ket_koordinasi : ''}}"   class="form-control">
            </div>
        </div>
       <div class="col-6 mb-2">
            <label for="pengkajian_fungsi_gangguan_fungsi" class="form-label">i. Kesimpulan Gangguan Fungsi : </label>
            <div class="d-flex">
                <select  class="form-select me-2" id="pengkajian_fungsi_gangguan_fungsi"  name="pengkajian_fungsi_gangguan_fungsi" aria-label="Default select example">
...
<div>
    ...
    <div class="row">
        <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="riwayat_psiko_kondisipsiko"  name="riwayat_psiko_kondisipsiko" aria-label="Default select example">
        ...
        <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="riwayat_psiko_adakah_prilaku"  name="riwayat_psiko_adakah_prilaku" aria-label="Default select example">
                ...
                <input   placeholder="Keterangan" type="text" id="riwayat_psiko_ket_adakah_prilaku" name="riwayat_psiko_ket_adakah_prilaku" value="{{!empty($penilaian->riwayat_psiko_ket_adakah_perilaku) ? $penilaian->riwayat_psiko_ket_adakah_perilaku : ''}}"   class="form-control">
            </div>
        </div>
        <div class="col-6 mb-2">
        ...
        <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="riwayat_psiko_hubungan_pasien"  name="riwayat_psiko_hubungan_pasien" aria-label="Default select example">
        ...
        <div class="col-6 mb-2">
            ...
            <input   placeholder="Keterangan" type="text" id="" name=""   class="form-control" value="{{!empty($penilaian->class) ? $penilaian->class : ''}}">
        </div>
        <div class="col-6 mb-2">
            <label for="riwayat_psiko_tinggal_dengan" class="form-label">f. Tinggal Dengan  : </label>
            <div class="d-flex">
                <select  class="form-select me-2" id="riwayat_psiko_tinggal_dengan"  name="riwayat_psiko_tinggal_dengan" aria-label="Default select example">
                ...
                <input   placeholder="Keterangan" type="text" id="riwayat_psiko_ket_tinggal_dengan" name="riwayat_psiko_ket_tinggal_dengan" value="{{!empty($penilaian->riwayat_psiko_ket_tinggal_dengan) ? $penilaian->riwayat_psiko_ket_tinggal_dengan : ''}}"   class="form-control">
            </div>
        </div>
        <div class="col-6 mb-2">
            <label for="" class="form-label">g. Pekerjaan : </label>
            <input   placeholder="Keterangan" type="text" id="" class="form-control">
        </div>
        <div class="col-6 mb-2">
        ...
        <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="riwayat_psiko_budaya"  name="riwayat_psiko_budaya" aria-label="Default select example">
        ...
        <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="riwayat_psiko_pend_pj"  name="riwayat_psiko_pend_pj" aria-label="Default select example">
        ...
        <div class="col-6 mb-2">
            ...
            <div class="d-flex">
                <select  class="form-select me-2" id="riwayat_psiko_edukasi_pada"  name="riwayat_psiko_edukasi_pada" aria-label="Default select example">
                ...
                <input   placeholder="Keterangan" type="text" id="riwayat_psiko_ket_edukasi_pada" name="riwayat_psiko_ket_edukasi_pada" value="{{!empty($penilaian->riwayat_psiko_ket_edukasi_pada) ? $penilaian->riwayat_psiko_ket_edukasi_pada : ''}}"   class="form-control">
            </div>
        </div>
    </div>
        ...
        <div class="mb-2 ">
            <div class="row">
                <div class="col-4">
                    ...
                    <select  class="form-select"  id="penilaian_nyeri_hilang"  name="penilaian_nyeri_hilang" aria-label="Default select example">
            ...
            <div class="row">
                ...
                <div class="col ms-4    ">
                    ...
                    <select  class=" form-select" id="penilaian_nyeri_skala"  name="penilaian_nyeri_skala" aria-label="Default select example">
...
<div>
    ...
    <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex w-50 align-items-center">
            ...
            <select  class="w-75 form-select" id="penilaian_jatuh_skala1"  name="penilaian_jatuh_skala1" aria-label="Default select example">
            ...
            <input  type="number" name="penilaian_jatuh_nilai1" value="{{!empty($penilaian->penilaian_jatuh_nilai1) ? $penilaian->penilaian_jatuh_nilai1 : ''}}" id="penilaian_jatuh_nilai1" class="w-25 form-control">
        </div>
    </div>
    <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex w-50 align-items-center">
            ...
            <select  class="w-75 form-select" id="penilaian_jatuh_skala2"  name="penilaian_jatuh_skala2" aria-label="Default select example">
            ...
            <input  type="number" name="penilaian_jatuh_nilai2" value="{{!empty($penilaian->penilaian_jatuh_nilai2) ? $penilaian->penilaian_jatuh_nilai2 : ''}}" id="penilaian_jatuh_nilai2" class="w-25 form-control">
        </div>
    </div>
    <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex w-50 align-items-center">
            ...
            <select  class="w-75 form-select" id="penilaian_jatuh_skala3"  name="penilaian_jatuh_skala3" aria-label="Default select example">
            ...
            <input  type="number" name="penilaian_jatuh_nilai3" value="{{!empty($penilaian->penilaian_jatuh_nilai3) ? $penilaian->penilaian_jatuh_nilai3 : ''}}" id="penilaian_jatuh_nilai3" class="w-25 form-control">
        </div>
    </div>
    <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex w-50 align-items-center">
            ...
            <select  class="w-75 form-select" id="penilaian_jatuh_skala4"  name="penilaian_jatuh_skala4" aria-label="Default select example">
            ...
            <input  type="number" name="penilaian_jatuh_nilai4" value="{{!empty($penilaian->penilaian_jatuh_nilai4) ? $penilaian->penilaian_jatuh_nilai4 : ''}}" id="penilaian_jatuh_nilai4" class="w-25 form-control">
        </div>
    </div>
    <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex w-50 align-items-center">
            ...
            <select  class="w-75 form-select" id="penilaian_jatuh_skala5"  name="penilaian_jatuh_skala5" aria-label="Default select example">
            ...
            <input  type="number" name="penilaian_jatuh_nilai5" value="{{!empty($penilaian->penilaian_jatuh_nilai5) ? $penilaian->penilaian_jatuh_nilai5 : ''}}" id="penilaian_jatuh_nilai5" class="w-25 form-control">
        </div>
    </div>
    <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex w-50 align-items-center">
            ...
            <select  class="w-75 form-select" id="penilaian_jatuh_skala6"  name="penilaian_jatuh_skala6" aria-label="Default select example">
            ...
            <input  type="number" name="penilaian_jatuh_nilai6" value="{{!empty($penilaian->penilaian_jatuh_nilai6) ? $penilaian->penilaian_jatuh_nilai6 : ''}}" id="penilaian_jatuh_nilai6" class="w-25 form-control">
        </div>
    </div>
    <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex w-50 align-items-center justify-content-end">
            ...
            <input  type="number" name="penilaian_jatuh_totalnilai" value="{{!empty($penilaian->penilaian_jatuh_totalnilai) ? $penilaian->penilaian_jatuh_totalnilai : ''}}" id="penilaian_jatuh_totalnilai" class="w-25 form-control">
        </div>
    </div>
...
<div>
    ...
    <div class=" d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex w-50 align-items-center">
            ...
            <select  class="w-75 form-select" id="skrining_gizi1"  name="skrining_gizi1" aria-label="Default select example">
            ...
            <input  type="number" name="nilai_gizi1" value="{{!empty($penilaian->nilai_gizi1) ? $penilaian->nilai_gizi1 : ''}}" id="nilai_gizi1" class="w-25 form-control">
        </div>
    </div>
