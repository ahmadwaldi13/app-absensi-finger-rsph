<form action="{{url('/penilaian-perawat-umum/update')}}" method="post">
    ...
    <div class="row mb-3">
        ...
        <div class="col-3 mb-2">
            ...
            <select  class="form-select" id="kasus_trauma" name="kasus_trauma" aria-label="Default select " >
        ...
        <div class="col-3 mb-2">
            ...
            <select  class="form-select" id="tiba_diruang_rawat" name="tiba_diruang_rawat" aria-label="Default select " >
        ...
        <div class="col-3 mb-2">
            ...
            <select  class="form-select" id="cara_masuk" name="cara_masuk" aria-label="Default select " >
    ...
    <div>
        ...
        <div class="row align-items-end">
            ...
            <div class="col-6 mb-2 ">
                ...
                <input  type="text" class="form-control" name="riwayat_pembedahan" value="{{!empty($penilaian->riwayat_pembedahan) ? $penilaian->riwayat_pembedahan : ''}}"  id='riwayat_pembedahan' value="">
            </div>
            <div class="col-6 mb-2 ">
                <label for="riwayat_dirawat_dirs" class="form-label">Riwayat Dirawat RS</label>
                <input  type="text" class="form-control" name="riwayat_dirawat_dirs" value="{{!empty($penilaian->riwayat_dirawat_dirs) ? $penilaian->riwayat_dirawat_dirs : ''}}"  id='riwayat_dirawat_dirs' value="">
            </div>
            <div class="col-6 mb-2">
                <label for="alat_bantu_dipakai" class="form-label">Alat Bantu Yang Dipakai : </label>
                <select  class="form-select" id="alat_bantu_dipakai" name="alat_bantu_dipakai" aria-label="Default select ">
            ...
            <div class="col mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select w-25" id="riwayat_kehamilan"  name="riwayat_kehamilan" aria-label="Default select example">
                    ...
                    <input  type="text" class="form-control w-75" name="riwayat_kehamilan_perkiraan" value="{{!empty($penilaian->riwayat_kehamilan_perkiraan) ? $penilaian->riwayat_kehamilan_perkiraan : ''}}"  id='riwayat_kehamilan_perkiraan' value="">
                </div>
                
            </div>
            <div class="col-6 mb-2 ">
                <label for="riwayat_tranfusi" class="form-label">Riwayat Transfusi Darah</label>
                <input  type="text" class="form-control" name="riwayat_tranfusi" value="{{!empty($penilaian->riwayat_tranfusi) ? $penilaian->riwayat_tranfusi : ''}}"  id='riwayat_transfusi' value="">
            </div>
            <div class="col-6 mb-2 ">
                <label for="riwayat_alergi" class="form-label">Riwayat Alergi</label>
                <input  type="text" class="form-control" name="riwayat_alergi" value="{{!empty($penilaian->riwayat_alergi) ? $penilaian->riwayat_alergi : ''}}"  id='riwayat_alergi' value="">
            </div>
            ...
            <div class="ms-2 row">
                <div class="col-6 mb-2">
                    ...
                    <div class="d-flex">
                        <select  class="form-select me-2" id="riwayat_merokok"  name="riwayat_merokok" aria-label="Default select example">
                        ...
                        <div class="input-group  me-2">
                            <input   type="text" id="riwayat_merokok_jumlah" name="riwayat_merokok_jumlah" value="{{!empty($penilaian->riwayat_merokok_jumlah) ? $penilaian->riwayat_merokok_jumlah : ''}}"    class="form-control">
                ...
                <div class="col-6 mb-2">
                    ...
                    <div class="d-flex">
                        <select  class="form-select me-2" id="riwayat_alkohol"  name="riwayat_alkohol" aria-label="Default select example">
                        ...
                        <div class="input-group  me-2">
                            <input   type="text" id="riwayat_alkohol_jumlah" name="riwayat_alkohol_jumlah" value="{{!empty($penilaian->riwayat_alkohol_jumlah) ? $penilaian->riwayat_alkohol_jumlah : ''}}"    class="form-control">
                ...
                <div class="col-6 mb-2">
                    ...
                    <div class="d-flex">
                        <select  class="form-select me-2" id="riwayat_narkoba"  name="riwayat_narkoba" aria-label="Default select example">
                ...
                <div class="col-6 mb-2">
                    ...
                    <div class="d-flex">
                        <select  class="form-select me-2" id="riwayat_olahraga"  name="riwayat_olahraga" aria-label="Default select example">
    ...
    <div>
        ...
        <div class="row align-items-end">
            <div class="col-3 mb-2">
                ...
                <input  type="text" name="pemeriksaan_mental" value="{{!empty($penilaian->pemeriksaan_mental) ? $penilaian->pemeriksaan_mental : ''}}"  id="pemeriksaan_mental" class="form-control">
            </div>
            <div class="col-3 mb-2">
                <label for="pemeriksaan_keadaan_umum" class="form-label">keadaan Umum : </label>
                <select  class="form-select" id="pemeriksaan_keadaan_umum" name="pemeriksaan_keadaan_umum" aria-label="Default select ">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="input-group">
                    <input  type="text" name="pemeriksaan_td" value="{{!empty($penilaian->pemeriksaan_td) ? $penilaian->pemeriksaan_td : ''}}"  id="pemeriksaan_td" class="form-control">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="input-group">
                    <input  type="text" id="pemeriksaan_nadi" name="pemeriksaan_nadi" value="{{!empty($penilaian->pemeriksaan_nadi) ? $penilaian->pemeriksaan_nadi : ''}}"  class="form-control">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="input-group">
                    <input  type="text" id="pemeriksaan_rr" name="pemeriksaan_rr" value="{{!empty($penilaian->pemeriksaan_rr) ? $penilaian->pemeriksaan_rr : ''}}"  class="form-control">
                    <span class="input-group-text" id="ModalPetugas">x / Menit</span>
                </div>
            </div>
            <div class="col-3 mb-2">
                ...
                <div class="input-group">
                    <input  type="text" id="pemeriksaan_suhu" name="pemeriksaan_suhu" value="{{!empty($penilaian->pemeriksaan_suhu) ? $penilaian->pemeriksaan_suhu : ''}}"  class="form-control">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="input-group">
                    <input  type="text" id="pemeriksaan_gcs" name="pemeriksaan_gcs" value="{{!empty($penilaian->pemeriksaan_gcs) ? $penilaian->pemeriksaan_gcs : ''}}"  class="form-control">
                </div>
            </div>
            <div class="col-3 mb-2">
                <label for="pemeriksaan_bb" class="form-label">BB : </label>
                <div class="input-group">
                    <input  type="text" id="pemeriksaan_bb" name="pemeriksaan_bb" value="{{!empty($penilaian->pemeriksaan_bb) ? $penilaian->pemeriksaan_bb : ''}}"  class="form-control">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="input-group">
                    <input  type="text" id="pemeriksaan_tb" name="pemeriksaan_tb" value="{{!empty($penilaian->pemeriksaan_tb) ? $penilaian->pemeriksaan_tb : ''}}"  class="form-control">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="input-group">
                    <input  type="text" id="pemeriksaan_spo" name="pemeriksaan_spo" value="{{!empty($penilaian->pemeriksaan_spo) ? $penilaian->pemeriksaan_spo : ''}}"  class="form-control">
                    <span class="input-group-text" id="ModalPetugas">%</span>
                </div>
            </div>
        </div>
        ...
        <div class="ms-2 row">
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_susunan_kepala"  name="pemeriksaan_susunan_kepala" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_susunan_kepala_keterangan" name="pemeriksaan_susunan_kepala_keterangan" value="{{!empty($penilaian->pemeriksaan_susunan_kepala_keterangan) ? $penilaian->pemeriksaan_susunan_kepala_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
                <label for="pemeriksaan_susunan_wajah" class="form-label">Wajah : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_susunan_wajah"  name="pemeriksaan_susunan_wajah" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_susunan_wajah_keterangan" name="pemeriksaan_susunan_wajah_keterangan" value="{{!empty($penilaian->pemeriksaan_susunan_wajah_keterangan) ? $penilaian->pemeriksaan_susunan_wajah_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-3 mb-2">
                <label for="pemeriksaan_susunan_leher" class="form-label">Leher : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_susunan_leher"  name="pemeriksaan_susunan_leher" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_susunan_kejang"  name="pemeriksaan_susunan_kejang" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_susunan_kejang_keterangan" name="pemeriksaan_susunan_kejang_keterangan" value="{{!empty($penilaian->pemeriksaan_susunan_kejang_keterangan) ? $penilaian->pemeriksaan_susunan_kejang_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-3 mb-2">
                <label for="pemeriksaan_susunan_sensorik" class="form-label">Sensorik : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_susunan_sensorik"  name="pemeriksaan_susunan_sensorik" aria-label="Default select example">
        ...
        <div class="ms-2 row">
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_kardiovaskuler_pulsasi"  name="pemeriksaan_kardiovaskuler_pulsasi" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_kardiovaskuler_sirkulasi"  name="pemeriksaan_kardiovaskuler_sirkulasi" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_kardiovaskuler_sirkulasi_keterangan" name="pemeriksaan_kardiovaskuler_sirkulasi_keterangan" value="{{!empty($penilaian->pemeriksaan_kardiovaskuler_sirkulasi_keterangan) ? $penilaian->pemeriksaan_kardiovaskuler_sirkulasi_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-3 mb-2">
                <label for="pemeriksaan_kardiovaskuler_denyut_nadi" class="form-label">Denyu Nadi : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_kardiovaskuler_denyut_nadi"  name="pemeriksaan_kardiovaskuler_denyut_nadi" aria-label="Default select example">
        ...
        <div class="ms-2 row">
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_respirasi_retraksi"  name="pemeriksaan_respirasi_retraksi" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_respirasi_pola_nafas"  name="pemeriksaan_respirasi_pola_nafas" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_respirasi_suara_nafas"  name="pemeriksaan_respirasi_suara_nafas" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_respirasi_batuk"  name="pemeriksaan_respirasi_batuk" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_respirasi_volume_pernafasan"  name="pemeriksaan_respirasi_volume_pernafasan" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_respirasi_irama_nafas"  name="pemeriksaan_respirasi_irama_nafas" aria-label="Default select example">
        ...
        <div class="ms-2 row">
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_gastrointestinal_mulut"  name="pemeriksaan_gastrointestinal_mulut" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_gastrointestinal_mulut_keterangan" name="pemeriksaan_gastrointestinal_mulut_keterangan" value="{{!empty($penilaian->pemeriksaan_gastrointestinal_mulut_keterangan) ? $penilaian->pemeriksaan_gastrointestinal_mulut_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
                <label for="pemeriksaan_gastrointestinal_tenggorokan" class="form-label">Tenggorokan : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_gastrointestinal_tenggorokan"  name="pemeriksaan_gastrointestinal_tenggorokan" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_gastrointestinal_lidah_keterangan" name="pemeriksaan_gastrointestinal_lidah_keterangan" value="{{!empty($penilaian->pemeriksaan_gastrointestinal_lidah_keterangan) ? $penilaian->pemeriksaan_gastrointestinal_lidah_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
                <label for="pemeriksaan_gastrointestinal_abdomen" class="form-label">Abdomen : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_gastrointestinal_abdomen"  name="pemeriksaan_gastrointestinal_abdomen" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_gastrointestinal_abdomen_keterangan" name="pemeriksaan_gastrointestinal_abdomen_keterangan" value="{{!empty($penilaian->pemeriksaan_gastrointestinal_abdomen_keterangan) ? $penilaian->pemeriksaan_gastrointestinal_abdomen_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
                <label for="pemeriksaan_gastrointestinal_gigi" class="form-label">Gigi : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_gastrointestinal_gigi"  name="pemeriksaan_gastrointestinal_gigi" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_gastrointestinal_gigi_keterangan" name="pemeriksaan_gastrointestinal_gigi_keterangan" value="{{!empty($penilaian->pemeriksaan_gastrointestinal_gigi_keterangan) ? $penilaian->pemeriksaan_gastrointestinal_gigi_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-3 mb-2">
                <label for="pemeriksaan_gastrointestinal_peistatik_usus" class="form-label">Peistatik Usus : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_gastrointestinal_peistatik_usus"  name="pemeriksaan_gastrointestinal_peistatik_usus" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_gastrointestinal_anus"  name="pemeriksaan_gastrointestinal_anus" aria-label="Default select example">
        ...
        <div class="ms-2 row">
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_neurologi_sensorik"  name="pemeriksaan_neurologi_sensorik" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_neurologi_pengelihatan"  name="pemeriksaan_neurologi_pengelihatan" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_neurologi_pengelihatan_keterangan" name="pemeriksaan_neurologi_pengelihatan_keterangan" value="{{!empty($penilaian->pemeriksaan_neurologi_pengelihatan_keterangan) ? $penilaian->pemeriksaan_neurologi_pengelihatan_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-3 mb-2">
                <label for="pemeriksaan_neurologi_alat_bantu_penglihatan" class="form-label">Alat Bantu Penglihatan : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_neurologi_alat_bantu_penglihatan"  name="pemeriksaan_neurologi_alat_bantu_penglihatan" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_neurologi_motorik"  name="pemeriksaan_neurologi_motorik" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_neurologi_pendengaran"  name="pemeriksaan_neurologi_pendengaran" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_neurologi_bicara"  name="pemeriksaan_neurologi_bicara" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_neurologi_bicara_keterangan" name="pemeriksaan_neurologi_bicara_keterangan" value="{{!empty($penilaian->pemeriksaan_neurologi_bicara_keterangan) ? $penilaian->pemeriksaan_neurologi_bicara_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-3 mb-2">
                <label for="pemeriksaan_neurologi_kekuatan_otot" class="form-label">Otot : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_neurologi_kekuatan_otot"  name="pemeriksaan_neurologi_kekuatan_otot" aria-label="Default select example">
        ...
        <div class="ms-2 row">
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_integument_kulit"  name="pemeriksaan_integument_kulit" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_integument_warnakulit"  name="pemeriksaan_integument_warnakulit" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_integument_turgor"  name="pemeriksaan_integument_turgor" aria-label="Default select example">
            ...
            <div class="col-3 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_integument_dekubitas"  name="pemeriksaan_integument_dekubitas" aria-label="Default select example">
        ...
        <div class="ms-2 row">
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_muskuloskletal_oedema"  name="pemeriksaan_muskuloskletal_oedema" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_muskuloskletal_oedema_keterangan" name="pemeriksaan_muskuloskletal_oedema_keterangan" value="{{!empty($penilaian->pemeriksaan_muskuloskletal_oedema_keterangan) ? $penilaian->pemeriksaan_muskuloskletal_oedema_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
                <label for="pemeriksaan_muskuloskletal_pergerakan_sendi" class="form-label">Pregerakan Sendi : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_muskuloskletal_pergerakan_sendi"  name="pemeriksaan_muskuloskletal_pergerakan_sendi" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_muskuloskletal_kekauatan_otot"  name="pemeriksaan_muskuloskletal_kekauatan_otot" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_muskuloskletal_fraktur"  name="pemeriksaan_muskuloskletal_fraktur" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pemeriksaan_muskuloskletal_fraktur_keterangan" name="pemeriksaan_muskuloskletal_fraktur_keterangan" value="{{!empty($penilaian->pemeriksaan_muskuloskletal_fraktur_keterangan) ? $penilaian->pemeriksaan_muskuloskletal_fraktur_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
                <label for="pemeriksaan_muskuloskletal_nyeri_sendi" class="form-label">Nyeri Sendi : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pemeriksaan_muskuloskletal_nyeri_sendi"  name="pemeriksaan_muskuloskletal_nyeri_sendi" aria-label="Default select example">
                    ...
                    <input   placeholder="keterangan" type="text" id="pemeriksaan_muskuloskletal_nyeri_sendi_keterangan" name="pemeriksaan_muskuloskletal_nyeri_sendi_keterangan" value="{{!empty($penilaian->pemeriksaan_muskuloskletal_nyeri_sendi_keterangan) ? $penilaian->pemeriksaan_muskuloskletal_nyeri_sendi_keterangan : ''}}"    class="form-control">
                </div>
            </div>
                ...
                <div class="ms-2 row">
                    <div class="col-4 mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            <input   placeholder="Keterangan" type="text" id="pemeriksaan_eliminasi_bab_jumlah" name="pemeriksaan_eliminasi_bab_jumlah" value="{{!empty($penilaian->pemeriksaan_eliminasi_bab_jumlah) ? $penilaian->pemeriksaan_eliminasi_bab_jumlah : ''}}"    class="form-control">
                            <span class="mx-2">X/</span>
                            <input   placeholder="Keterangan" type="text" id="pemeriksaan_eliminasi_bab_durasi" name="pemeriksaan_eliminasi_bab_durasi" value="{{!empty($penilaian->pemeriksaan_eliminasi_bab_durasi) ? $penilaian->pemeriksaan_eliminasi_bab_durasi : ''}}"    class="form-control">
                        </div>
                    </div>
                    <div class="col-4 mb-2">
                        <label for="pemeriksaan_eliminasi_bab_" class="form-label"> Konsistensi : </label>
                        <input   placeholder="Keterangan" type="text" id="pemeriksaan_eliminasi_bab_konsistensi" name="pemeriksaan_eliminasi_bab_konsistensi" value="{{!empty($penilaian->pemeriksaan_eliminasi_bab_konsistensi) ? $penilaian->pemeriksaan_eliminasi_bab_konsistensi : ''}}"    class="form-control">
                    </div>
                    <div class="col-4 mb-2">
                        <label for="pemeriksaan_eliminasi_bab_" class="form-label"> Warna : </label>
                        <input   placeholder="Keterangan" type="text" id="pemeriksaan_eliminasi_bab_warna" name="pemeriksaan_eliminasi_bab_warna" value="{{!empty($penilaian->pemeriksaan_eliminasi_bab_warna) ? $penilaian->pemeriksaan_eliminasi_bab_warna : ''}}"    class="form-control">
                    </div>
                </div>
            </div>
            <div class="col-12 mb-2">
                ...
                <div class="ms-2 row">
                    <div class="col-4 mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            <input   placeholder="Keterangan" type="text" id="pemeriksaan_eliminasi_bak_jumlah" name="pemeriksaan_eliminasi_bak_jumlah" value="{{!empty($penilaian->pemeriksaan_eliminasi_bak_jumlah) ? $penilaian->pemeriksaan_eliminasi_bak_jumlah : ''}}"    class="form-control">
                            <span class="mx-2">X/</span>
                            <input   placeholder="Keterangan" type="text" id="pemeriksaan_eliminasi_bak_durasi" name="pemeriksaan_eliminasi_bak_durasi" value="{{!empty($penilaian->pemeriksaan_eliminasi_bak_durasi) ? $penilaian->pemeriksaan_eliminasi_bak_durasi : ''}}"    class="form-control">
                        </div>
                    </div>
                    <div class="col-4 mb-2">
                        <label for="pemeriksaan_eliminasi_bak_" class="form-label"> Warna : </label>
                        <input   placeholder="Keterangan" type="text" id="pemeriksaan_eliminasi_bak_warna" name="pemeriksaan_eliminasi_bak_warna" value="{{!empty($penilaian->pemeriksaan_eliminasi_bak_warna) ? $penilaian->pemeriksaan_eliminasi_bak_warna : ''}}"    class="form-control">
                    </div>
                    <div class="col-4 mb-2">
                        <label for="pemeriksaan_eliminasi_bak_" class="form-label"> Lain-lain : </label>
                        <input   placeholder="Keterangan" type="text" id="pemeriksaan_eliminasi_bak_lainlain" name="pemeriksaan_eliminasi_bak_lainlain" value="{{!empty($penilaian->pemeriksaan_eliminasi_bak_lainlain) ? $penilaian->pemeriksaan_eliminasi_bak_lainlain : ''}}"    class="form-control">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div>
        ...
        <div class="ms-2 row">
            <div class="col-4 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pola_aktifitas_mandi"  name="pola_aktifitas_mandi" aria-label="Default select example">
            ...
            <div class="col-4 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pola_aktifitas_makanminum"  name="pola_aktifitas_makanminum" aria-label="Default select example">
            ...
            <div class="col-4 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pola_aktifitas_berpakaian"  name="pola_aktifitas_berpakaian" aria-label="Default select example">
            ...
            <div class="col-4 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pola_aktifitas_eliminasi"  name="pola_aktifitas_eliminasi" aria-label="Default select example">
            ...
            <div class="col-4 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pola_aktifitas_berpindah"  name="pola_aktifitas_berpindah" aria-label="Default select example">
        ...
        <div class="col-3">
                ...
                <div class="input-group  me-2">
                    <input   type="text" id="pola_nutrisi_makan" name="pola_nutrisi_makan" value="{{!empty($penilaian->pola_nutrisi_makan) ? $penilaian->pola_nutrisi_makan : ''}}"    class="form-control">
        ...
        <div class="col-3">
                ...
                <div class="input-group  me-2">
                    <input   type="text" id="pola_nutrisi_frekuensi_makan" name="pola_nutrisi_frekuensi_makan" value="{{!empty($penilaian->pola_nutrisi_frekuensi_makan) ? $penilaian->pola_nutrisi_frekuensi_makan : ''}}"    class="form-control">
                    <span class="input-group-text">x/hari</span>
                </div>
            </div> 
        <div class="col-6">
                <label for="pola_nutrisi_jenis_makanan" class="form-label">Jenis Makanan</label>
                <input   type="text" id="pola_nutrisi_jenis_makanan" name="pola_nutrisi_jenis_makanan" value="{{!empty($penilaian->pola_nutrisi_jenis_makanan) ? $penilaian->pola_nutrisi_jenis_makanan : ''}}"    class="form-control">
            </div> 
        </div>
        ...
        <div class="col-6">
                ...
                <div class="d-flex ">
                    <div class="input-group  me-2">
                        <input   type="text" id="pola_tidur_lama_tidur" name="pola_tidur_lama_tidur" value="{{!empty($penilaian->pola_tidur_lama_tidur) ? $penilaian->pola_tidur_lama_tidur : ''}}"    class="form-control">
                        <span class="input-group-text">jam/hari</span>
                    </div>
                    <select  class="form-select me-2" id="pola_tidur_gangguan"  name="pola_tidur_gangguan" aria-label="Default select example">
    ...
    <div>
        ...
        <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pengkajian_fungsi_kemampuan_sehari"  name="pengkajian_fungsi_kemampuan_sehari" aria-label="Default select example">
        ...
        <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pengkajian_fungsi_berjalan"  name="pengkajian_fungsi_berjalan" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_berjalan_keterangan" name="pengkajian_fungsi_berjalan_keterangan" value="{{!empty($penilaian->pengkajian_fungsi_berjalan_keterangan) ? $penilaian->pengkajian_fungsi_berjalan_keterangan : ''}}"    class="form-control">
                </div>
            </div>
        <div class="col-6 mb-2">
                <label for="pengkajian_fungsi_aktifitas" class="form-label">c. Aktifitas : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pengkajian_fungsi_aktifitas"  name="pengkajian_fungsi_aktifitas" aria-label="Default select example">
        ...
        <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pengkajian_fungsi_ambulasi"  name="pengkajian_fungsi_ambulasi" aria-label="Default select example">
        ...
        <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="pengkajian_fungsi_ekstrimitas_atas"  name="pengkajian_fungsi_ekstrimitas_atas" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_ekstrimitas_atas_keterangan" name="pengkajian_fungsi_ekstrimitas_atas_keterangan" value="{{!empty($penilaian->pengkajian_fungsi_ekstrimitas_atas_keterangan) ? $penilaian->pengkajian_fungsi_ekstrimitas_atas_keterangan : ''}}"    class="form-control">
                </div>
            </div>
        <div class="col-6 mb-2">
                <label for="pengkajian_fungsi_ekstrimitas_bawah" class="form-label">f. ekstrimitas Bawah : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pengkajian_fungsi_ekstrimitas_bawah"  name="pengkajian_fungsi_ekstrimitas_bawah" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_ekstrimitas_bawah_keterangan" name="pengkajian_fungsi_ekstrimitas_bawah_keterangan" value="{{!empty($penilaian->pengkajian_fungsi_ekstrimitas_bawah_keterangan) ? $penilaian->pengkajian_fungsi_ekstrimitas_bawah_keterangan : ''}}"    class="form-control">
                </div>
            </div>
        <div class="col-6 mb-2">
                <label for="pengkajian_fungsi_menggenggam" class="form-label">g. Kemampuan Menggenggam : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pengkajian_fungsi_menggenggam"  name="pengkajian_fungsi_menggenggam" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_menggenggam_keterangan" name="pengkajian_fungsi_menggenggam_keterangan" value="{{!empty($penilaian->pengkajian_fungsi_menggenggam_keterangan) ? $penilaian->pengkajian_fungsi_menggenggam_keterangan : ''}}"    class="form-control">
                </div>
            </div>
        <div class="col-6 mb-2">
                <label for="pengkajian_fungsi_koordinasi" class="form-label">h. Kemampuan Koordinasi : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pengkajian_fungsi_koordinasi"  name="pengkajian_fungsi_koordinasi" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="pengkajian_fungsi_koordinasi_keterangan" name="pengkajian_fungsi_koordinasi_keterangan" value="{{!empty($penilaian->pengkajian_fungsi_koordinasi_keterangan) ? $penilaian->pengkajian_fungsi_koordinasi_keterangan : ''}}"    class="form-control">
                </div>
            </div>
        <div class="col-6 mb-2">
                <label for="pengkajian_fungsi_kesimpulan" class="form-label">i. Kesimpulan Gangguan Fungsi : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="pengkajian_fungsi_kesimpulan"  name="pengkajian_fungsi_kesimpulan" aria-label="Default select example">
    ...
    <div>
        ...
        <div class="row">
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="riwayat_psiko_kondisi_psiko"  name="riwayat_psiko_kondisi_psiko" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="riwayat_psiko_perilaku"  name="riwayat_psiko_perilaku" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="riwayat_psiko_perilaku_keterangan" name="riwayat_psiko_perilaku_keterangan" value="{{!empty($penilaian->riwayat_psiko_perilaku_keterangan) ? $penilaian->riwayat_psiko_perilaku_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
                <label for="riwayat_psiko_gangguan_jiwa" class="form-label">c. Gangguan Jiwa di Masa Lalu  : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="riwayat_psiko_gangguan_jiwa"  name="riwayat_psiko_gangguan_jiwa" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="riwayat_psiko_hubungan_keluarga"  name="riwayat_psiko_hubungan_keluarga" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <input   placeholder="Keterangan" type="text" id="" name=""   class= "form-control">
            </div>
            <div class="col-6 mb-2">
                <label for="riwayat_psiko_tinggal" class="form-label">f. Tinggal Dengan  : </label>
                <div class="d-flex">
                    <select  class="form-select me-2" id="riwayat_psiko_tinggal"  name="riwayat_psiko_tinggal" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="riwayat_psiko_tinggal_keterangan" name="riwayat_psiko_tinggal_keterangan" value="{{!empty($penilaian->riwayat_psiko_tinggal_keterangan) ? $penilaian->riwayat_psiko_tinggal_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
                <label for="" class="form-label">g. Pekerjaan : </label>
                <input   placeholder="Keterangan" type="text" id="" name="form-control">
            </div>
            <div class="col-6 mb-2">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="riwayat_psiko_nilai_kepercayaan"  name="riwayat_psiko_nilai_kepercayaan" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="riwayat_psiko_kepercayaan_keterangan" name="riwayat_psiko_kepercayaan_keterangan" value="{{!empty($penilaian->riwayat_psiko_kepercayaan_keterangan) ? $penilaian->riwayat_psiko_kepercayaan_keterangan : ''}}"    class="form-control">
                </div>
            </div>
            <div class="col-6 mb-2">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="riwayat_psiko_pendidikan_pj"  name="riwayat_psiko_pendidikan_pj" aria-label="Default select example">
            ...
            <div class="col-6 mb-2">
                ...
                <div class="d-flex">
                    <select  class="form-select me-2" id="riwayat_psiko_edukasi_diberikan"  name="riwayat_psiko_edukasi_diberikan" aria-label="Default select example">
                    ...
                    <input   placeholder="Keterangan" type="text" id="riwayat_psiko_edukasi_keterangan" name="riwayat_psiko_edukasi_keterangan" value="{{!empty($penilaian->riwayat_psiko_edukasi_keterangan) ? $penilaian->riwayat_psiko_edukasi_keterangan : ''}}"    class="form-control">
                </div>
            </div>
        </div>
            ...
            <div class="mb-2 ">
                <div class="row">
                    <div class="col-4">
                        ...
                        <select  class="form-select"  id="penilaian_nyeri"  name="penilaian_nyeri" aria-label="Default select example">
                    ...
                    <div class="col-8">
                        ...
                        <div class="d-flex">
                            <select  id="penilaian_nyeri_penyebab"  name="penilaian_nyeri_penyebab" class="form-select me-2" aria-label="Default select example">
                                @foreach (['Proses Penyakit', 'Benturan', 'Lain-lain'] as $item)
                                <option value="{{$item}}">{{$item}}</option> 
                                @endforeach
                            </select>
                            <input  type="text" class=" form-control" name="penilaian_nyeri_ket_penyebab" value="{{!empty($penilaian->penilaian_nyeri_ket_penyebab) ? $penilaian->penilaian_nyeri_ket_penyebab : ''}}"  id="penilaian_nyeri_ket_penyebab" placeholder="Keterangan" >
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        ...
                        <div class="d-flex">
                            <select  class="w-25 me-2 form-select" id="penilaian_nyeri_kualitas"  name="penilaian_nyeri_kualitas" aria-label="Default select example">
                                @foreach (['Seperti Tertusuk','Berdenyut','Teriris','Tertindih','Tertiban','Lain-lain'] as $item)
                                <option value="{{$item}}">{{$item}}</option> 
                                @endforeach
                            </select>
                            <input  type="text" class="w-75 form-control" name="penilaian_nyeri_ket_kualitas" value="{{!empty($penilaian->penilaian_nyeri_ket_kualitas) ? $penilaian->penilaian_nyeri_ket_kualitas : ''}}"  id="penilaian_nyeri_ket_kualitas"  placeholder="Keterangan" >
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col ms-4">
                        ...
                        <input  type="text" id="penilaian_nyeri_lokasi"  name="penilaian_nyeri_lokasi" value="{{!empty($penilaian->penilaian_nyeri_lokasi) ? $penilaian->penilaian_nyeri_lokasi : ''}}"  class=" form-control"   placeholder="Nilai" >
                    </div>
                    <div class="col">
                        <label for="penilaian_nyeri_menyebar" class="form-label">Menyebar:</label>
                        <select  class=" form-select"  id="penilaian_nyeri_menyebar"  name="penilaian_nyeri_menyebar" aria-label="Default select example">
                                @foreach (['Tidak','Ya'] as $item)
                                <option value="{{$item}}">{{$item}}</option> 
                                @endforeach
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col ">
                        ...
                        <div class="input-group">
                            <input  type="text" class="form-control" id="penilaian_nyeri_waktu"  name="penilaian_nyeri_waktu" value="{{!empty($penilaian->penilaian_nyeri_waktu) ? $penilaian->penilaian_nyeri_waktu : ''}}" >
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <div class="d-flex">
                            <select  class="form-select me-2" id="penilaian_nyeri_hilang"  name="penilaian_nyeri_hilang" aria-label="Default select example">
                                @foreach (['Istirahat','Medengar Musik','Minum Obat'] as $item)
                                    <option value="{{$item}}">{{$item}}</option> 
                                @endforeach
                            </select>
                            <input  type="text" class=" form-control" name="penilaian_nyeri_ket_hilang" value="{{!empty($penilaian->penilaian_nyeri_ket_hilang) ? $penilaian->penilaian_nyeri_ket_hilang : ''}}"  id="penilaian_nyeri_ket_hilang" placeholder="Nilai" >
                        </div>
                    </div>
                    <div class="col-8">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <select  class=" form-select" id="penilaian_nyeri_diberitahukan_dokter"  name="penilaian_nyeri_diberitahukan_dokter" aria-label="Default select example">
                                    @foreach (['Tidak','Ya'] as $item)
                                        <option value="{{$item}}">{{$item}}</option> 
                                    @endforeach
                                </select>
                            ...
                            <div class="col-8 d-flex align-items-center">
                                ...
                                <input  type="text" name="penilaian_nyeri_jam_diberitahukan_dokter" value="{{!empty($penilaian->penilaian_nyeri_jam_diberitahukan_dokter) ? $penilaian->penilaian_nyeri_jam_diberitahukan_dokter : ''}}"  id="penilaian_nyeri_jam_diberitahukan_dokter" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
        ...
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhmorse_skala1"  name="penilaian_jatuhmorse_skala1" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhmorse_nilai1" value="{{!empty($penilaian->penilaian_jatuhmorse_nilai1) ? $penilaian->penilaian_jatuhmorse_nilai1 : ''}}"  id="penilaian_jatuhmorse_nilai1" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhmorse_skala2"  name="penilaian_jatuhmorse_skala2" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhmorse_nilai2" value="{{!empty($penilaian->penilaian_jatuhmorse_nilai2) ? $penilaian->penilaian_jatuhmorse_nilai2 : ''}}"  id="penilaian_jatuhmorse_nilai2" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhmorse_skala3"  name="penilaian_jatuhmorse_skala3" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhmorse_nilai3" value="{{!empty($penilaian->penilaian_jatuhmorse_nilai3) ? $penilaian->penilaian_jatuhmorse_nilai3 : ''}}"  id="penilaian_jatuhmorse_nilai3" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhmorse_skala4"  name="penilaian_jatuhmorse_skala4" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhmorse_nilai4" value="{{!empty($penilaian->penilaian_jatuhmorse_nilai4) ? $penilaian->penilaian_jatuhmorse_nilai4 : ''}}"  id="penilaian_jatuhmorse_nilai4" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhmorse_skala5"  name="penilaian_jatuhmorse_skala5" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhmorse_nilai5" value="{{!empty($penilaian->penilaian_jatuhmorse_nilai5) ? $penilaian->penilaian_jatuhmorse_nilai5 : ''}}"  id="penilaian_jatuhmorse_nilai5" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhmorse_skala6"  name="penilaian_jatuhmorse_skala6" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhmorse_nilai6" value="{{!empty($penilaian->penilaian_jatuhmorse_nilai6) ? $penilaian->penilaian_jatuhmorse_nilai6 : ''}}"  id="penilaian_jatuhmorse_nilai6" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center justify-content-end">
                ...
                <input  type="number" name="penilaian_jatuhmorse_totalnilai" value="{{!empty($penilaian->penilaian_jatuhmorse_totalnilai) ? $penilaian->penilaian_jatuhmorse_totalnilai : ''}}"  id="penilaian_jatuhmorse_totalnilai" class="w-25 form-control">
            </div>
        </div>
        ...
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala1"  name="penilaian_jatuhsydney_skala1" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai1" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai1) ? $penilaian->penilaian_jatuhsydney_nilai1 : ''}}"  id="penilaian_jatuhsydney_nilai1" class="w-25 form-control">
            </div>
        </div>
        ...
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala2"  name="penilaian_jatuhsydney_skala2" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai2" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai2) ? $penilaian->penilaian_jatuhsydney_nilai2 : ''}}"  id="penilaian_jatuhsydney_nilai2" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala3"  name="penilaian_jatuhsydney_skala3" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai3" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai3) ? $penilaian->penilaian_jatuhsydney_nilai3 : ''}}"  id="penilaian_jatuhsydney_nilai3" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala4"  name="penilaian_jatuhsydney_skala4" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai4" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai4) ? $penilaian->penilaian_jatuhsydney_nilai4 : ''}}"  id="penilaian_jatuhsydney_nilai4" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala5"  name="penilaian_jatuhsydney_skala5" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai5" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai5) ? $penilaian->penilaian_jatuhsydney_nilai5 : ''}}"  id="penilaian_jatuhsydney_nilai5" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala6"  name="penilaian_jatuhsydney_skala6" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai6" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai6) ? $penilaian->penilaian_jatuhsydney_nilai6 : ''}}"  id="penilaian_jatuhsydney_nilai6" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            <span class="">7. Obat-obat Beresiko Tinggi (Diuretic, Narkotik, Sedativ, Anti Psikotik, Laksatif, Vasodiilator, Antiaritmia, Antihipertensi, Obat Hipoglikemik, Anti Depresan, Neuroleptik, NSAID)</span> <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala7"  name="penilaian_jatuhsydney_skala7" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai7" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai7) ? $penilaian->penilaian_jatuhsydney_nilai7 : ''}}"  id="penilaian_jatuhsydney_nilai7" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala8"  name="penilaian_jatuhsydney_skala8" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai8" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai8) ? $penilaian->penilaian_jatuhsydney_nilai8 : ''}}"  id="penilaian_jatuhsydney_nilai8" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala9"  name="penilaian_jatuhsydney_skala9" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai9" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai9) ? $penilaian->penilaian_jatuhsydney_nilai9 : ''}}"  id="penilaian_jatuhsydney_nilai9" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala10"  name="penilaian_jatuhsydney_skala10" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai10" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai10) ? $penilaian->penilaian_jatuhsydney_nilai10 : ''}}"  id="penilaian_jatuhsydney_nilai10" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <select  class="w-75 form-select" id="penilaian_jatuhsydney_skala11"  name="penilaian_jatuhsydney_skala11" aria-label="Default select example">
                ...
                <input  type="number" name="penilaian_jatuhsydney_nilai11" value="{{!empty($penilaian->penilaian_jatuhsydney_nilai11) ? $penilaian->penilaian_jatuhsydney_nilai11 : ''}}"    id="penilaian_jatuhsydney_nilai11" class="w-25 form-control">
            </div>
        </div>
        <div class="ms-5  d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex w-50 align-items-center">
                ...
                <input  type="number" name="penilaian_jatuhsydney_totalnilai" value="{{!empty($penilaian->penilaian_jatuhsydney_totalnilai) ? $penilaian->penilaian_jatuhsydney_totalnilai : ''}}"  id="penilaian_jatuhsydney_totalnilai" class="w-25 form-control">
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="d-flex">
                    <select  class="w-25 me-2 form-select" id="skrining_gizi_diagnosa_khusus"  name="skrining_gizi_diagnosa_khusus" aria-label="Default select example">
                    ...
                    <input  type="text" class="w-75 form-control" name="skrining_gizi_ket_diagnosa_khusus" value="{{!empty($penilaian->skrining_gizi_ket_diagnosa_khusus) ? $penilaian->skrining_gizi_ket_diagnosa_khusus : ''}}"  id="skrining_gizi_ket_diagnosa_khusus"  placeholder="Keterangan" >
                </div>
            </div>
            <div class="col">
                <label for="skrining_gizi_diketahui_dietisen" class="form-label">Sudah dibaca dan diketahui oleh Dietisen:</label>
                <div class="d-flex align-items-end">
                    <select  class="w-25 me-2 form-select" id="skrining_gizi_diketahui_dietisen"  name="skrining_gizi_diketahui_dietisen" aria-label="Default select example">
                        ...
                        <input  type="text" class="w-75 form-control" name="skrining_gizi_jam_diketahui_dietisen" value="{{!empty($penilaian->skrining_gizi_jam_diketahui_dietisen) ? $penilaian->skrining_gizi_jam_diketahui_dietisen : ''}}"  id="skrining_gizi_jam_diketahui_dietisen"  placeholder="Keterangan" >
                </div>
            </div>
        </div>    
    </div>
    ...
    <div class="row">
        <div class="col-6  border-end" style="height:400px">
            ...
            <div class="d-flex justify-content-end align-items-center">
                <a href='{{url("penilaian-perawat-umum/form_masalah")}}' class='modal-remote' data-modal-width='700px' data-modal-row="" data-modal-key='' data-modal-title='Tambah Masalah'>
                    <span class="fs-4  fw-bold text-white bg-primary border p-0 rounded-circle px-2">&plus;</span>
                </a>
            </div>
        ...
        {{-- <div class="col-6 " >
            ...
            <div class="overflow-auto h-75 alternate_child_color  px-3" >
                <div class="mb-3">
                    <div class="d-flex justify-content-end align-items-center">
                        <a href='{{url("$base_route/form_rencana")}}' class='modal-remote' data-modal-row="" data-modal-key='' data-modal-title='Tambah Rencana'>
                            <span class="fs-4  fw-bold text-white bg-primary border p-0 rounded-circle px-2">&plus;</span>
                        </a>
                    </div>
        ...
        <div class="col-6 " >
           <h5 class="text-center">RENCANA KEPERAWATAN LAINNYA</h5>
            <hr class="mb-2">
            <div class="overflow-auto h-100 alternate_child_color  px-3" >
                <div class="mb-3">
                    <label for="rencana" class="form-label">Rencana Keperawatan Lainnya</label>
                    <textarea class="form-control" id="rencana" name="rencana" rows="5"></textarea>
                </div>
            </div>
        </div>
