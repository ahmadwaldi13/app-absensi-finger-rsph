...
<div>
    ...
    <div class="row align-items-end">
        ...
        <div class="col-6 mb-2 ">
            ...
            <input readonly type="text" class="form-control" name="alergi" value="{{!empty($penilaian->alergi) ? $penilaian->alergi : ''}}"  value="{{!empty($penilaian->alergi) ? $penilaian->alergi : ''}}"  id='alergi' value="">
        </div>
    </div>
</div>
