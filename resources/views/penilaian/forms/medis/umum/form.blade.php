<form action="{{url('/penilaian-medis-umum/update')}}" method="post">
    @csrf
    <div class="row mb-3">
    ...
    <div>
        ...
        <div class="row align-items-end">
            ...
            <div class="col-6 mb-2 ">
                ...
                <input type="text" class="form-control" name="alergi" value="{{!empty($penilaian->alergi) ? $penilaian->alergi : ''}}"  value="{{!empty($penilaian->alergi) ? $penilaian->alergi : ''}}"  id='alergi' value="">
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="d-flex justify-content-center mb-5">
            <img src="{{asset('icon/semua.png')}}" style="width:100%;max-width:600px" alt="">
        </div>
        <div class="row mb-2">
    ...
    <div>
        ...
        <div class="row mb-2">
            <label for="penunjang" class="form-label">Keterangan</label>
    ...
    <div>
        ...
        <div class="row mb-2">
            ...
            <textarea class="form-control" id="konsulrujuk" name="konsulrujuk" rows="3">{{!empty($penilaian->konsulrujuk) ? $penilaian->konsulrujuk : ''}}</textarea>
        </div>
    </div>
