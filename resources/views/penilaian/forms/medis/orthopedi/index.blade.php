<form action="{{url('/penilaian-medis-orthopedi/create')}}" method="post" id="penilaian_perawat_umum">
    @csrf
    <div class="row mb-3">
        @include('penilaian.form_header', ['pj_form_type' => 'dokter'])
        <div class="col mb-2">
            <label for="tanggal" class="form-label">Tanggal : </label>
            <input type="text" class="form-control input-daterange input-date-time" name="tanggal" id="tanggal" required
                autocomplete="off">
        </div>
        <div class="col mb-2">
        ...
        <div class="row">
            <div class="col-6 row">
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="genetalia" name="genetalia" aria-label="Default select ">
                        <option value="-" selected>Pilih Keadaan</option>
                        <option value="Normal">Normal</option>
                        <option value="Abnormal">Abnormal</option>
                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-3"> <span class="text-primary hover-pointer set-value-data-table"
                                    data-target="#kd_dokter@val|#namaPetugas@val" data-value='{{$kode}}|{{$nama}}'>{{
                                    $nama }}</span></td>
