...
<div>
    ...
    <div class="row align-items-end">
        ...
        <div class="col-6 mb-2">
            ...
            <textarea readonly class="form-control" id="rpo" name="rpo" rows="3">{{ !empty($penilaian->rps) ? $penilaian->rps : '' }}</textarea>
        </div>
        <div class="col-6 mb-2">
            <label for="rpd" class="form-label">Riwayat Penyakit Dahulu</label>
            <textarea readonly class="form-control" id="rpd" name="rpd" rows="3">{{ !empty($penilaian->rps) ? $penilaian->rps : '' }}</textarea>
        </div>
        <div class="col-6 mb-2 ">
        ...
        <div class="col-3 mb-2">
            ...
            <div class="input-group">
                <input readonly type="text" id="bb" name="bb" class="form-control"
                    value="{{ !empty($penilaian->kesadaran) ? $penilaian->kesadaran : '' }}">
            </div>
        </div>
        <div class="col-3 mb-2">
...
<div>
    ...
    <div class="row">
        <div class="col-6">
            <div class="col-12 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input readonly type="text" class="form-control w-75" name="keterangan_kepala" id='keterangan_kepala'
            ...
            <div class="col-12 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input readonly type="text" class="form-control w-75" name="keterangan_thoraks" id='keterangan_thoraks'
            ...
            <div class="col-12 mb-2">
                ...
                <div class="d-flex">
                    ...
                    <input readonly type="text" class="form-control w-75" name="keterangan_abdomen" id='keterangan_abdomen'
            ...
            <div class="col-12 mb-2">
                ...
                <div class="d-flex">
                    <input readonly type="text" class="form-control w-25" name="columna" id='columna'
                    value="{{ !empty($penilaian->columna) ? $penilaian->columna : '' }}">
                    <input readonly type="text" class="form-control w-75" name="keterangan_columna" id='keterangan_columna'
            ...
            <div class="col-12 mb-2">
                ...
                <div class="d-flex">
                    <input readonly type="text" class="form-control w-25" name="muskulos" id='muskulos'
                        value="{{ !empty($penilaian->muskulos) ? $penilaian->muskulos : '' }}">
                    <input readonly type="text" class="form-control w-75" name="keterangan_muskulos" id='keterangan_muskulos'
        ...
        <div class="col-6">
            ...
            <textarea readonly class="form-control h-75" id="lainnya" name="lainnya" rows="5">{{ !empty($penilaian->lainnya) ? $penilaian->lainnya : '' }}</textarea>
    </div>
    </div>
</div>
<hr class="mb-5">
<div>
    ...
    <div class="row mb-2">
        <div class="col-4">
            ...
            <textarea readonly class="form-control" id="lab" name="lab" rows="3">{{ !empty($penilaian->lainnya) ? $penilaian->lainnya : '' }}</textarea>
        </div>
        <div class="col-4">
            <label for="rad" class="form-label">Radiologi</label>
            <textarea readonly class="form-control" id="rad" name="rad" rows="3">{{ !empty($penilaian->lainnya) ? $penilaian->lainnya : '' }}</textarea>
        </div>
        <div class="col-4">
            <label for="penunjanglain" class="form-label">Penunjang lainnya</label>
            <textarea readonly class="form-control" id="penunjanglain" name="penunjanglain" rows="3">{{ !empty($penilaian->lainnya) ? $penilaian->lainnya : '' }}</textarea>
        </div>
    </div>
</div>
<hr class="mb-5">
<div>
    ...
    <div class="row mb-2">
        ...
        <div class="col">
            ...
            <textarea readonly class="form-control" id="diagnosis2" name="diagnosis2" rows="3">{{ !empty($penilaian->diagnosis2) ? $penilaian->lainnya : '' }}</textarea>
        </div>
    </div>
</div>
<hr class="mb-5">
