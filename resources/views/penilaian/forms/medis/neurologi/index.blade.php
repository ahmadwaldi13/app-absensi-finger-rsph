<form action="{{ url('/penilaian-medis-neurologi/create') }}" method="post" id="penilaian_penyakit_umum">
    @csrf
    <div class="row mb-3">
                ...
                <div class="col-12">
                    ...
                    <div class="d-flex">
                        ...
                        <input type="text" class="form-control w-75" name="keterangan_muskulos"
                            id='keterangan_muskulos' value="">
                    </div>
                </div>
            </div>
            <div class="col-6">
                <h5 class="text-center">Lainnya</h5>
                        <textarea class="form-control h-75" id="lainnya" name="lainnya" rows="5"></textarea>
            </div>
    </div>
    <hr class="mb-5">
    <div>
