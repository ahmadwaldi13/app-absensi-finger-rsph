<form action="{{ url('/penilaian-medis-penyakit-dalam/update') }}" method="post">
    @csrf
    <div class="row mb-3">
    ...
    <div>
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <textarea class="form-control w-100 h-75" id="kondisi" name="kondisi" rows="3">{{ !empty($penilaian->status) ? $penilaian->status : '' }}</textarea>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="d-flex">
                        <select class="form-select w-25" id="kepala" name="kepala"
                            ...
                            <option value="Normal" {{ $penilaian->kepala === 'Normal' ? 'selected' : '' }}>Normal
                            </option>
                            <option value="Abnormal" {{ $penilaian->kepala === 'Abnormal' ? 'selected' : '' }}>
                                Abnormal
                            </option>
                            <option value="Tidak Diperiksa"
                                {{ $penilaian->kepala === 'Tidak Diperiksa' ? 'selected' : '' }}>Tidak Diperiksa
                            </option>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="d-flex">
                        <select class="form-select w-25" id="kepala" name="kepala"
                            ...
                            <option value="Abnormal" {{ $penilaian->thoraks === 'Abnormal' ? 'selected' : '' }}>
                                Abnormal
                            </option>
                            <option value="Tidak Diperiksa"
                                {{ $penilaian->thoraks === 'Tidak Diperiksa' ? 'selected' : '' }}>Tidak Diperiksa
                            </option>
                        </select>
                        <input type="text" class="form-control w-75" name="keterangan_thorak"
                ...
                <div class="row">
                    ...
                    <div class="d-flex">
                        <select class="form-select w-25" id="abdomen" name="abdomen"
                            ...
                            <option value="Abnormal" {{ $penilaian->abdomen === 'Abnormal' ? 'selected' : '' }}>
                                Abnormal
                            </option>
                            <option value="Tidak Diperiksa"
                                {{ $penilaian->kepala === 'Tidak Diperiksa' ? 'selected' : '' }}>Tidak Diperiksa
    ...
    <div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-4">
                ...
                <textarea class="form-control" id="penunjanglain" name="penunjanglain" rows="3">{{ !empty($penilaian->penunjanglain) ? $penilaian->penunjanglain : '' }}</textarea>
            </div>
        </div>
    </div>
    <hr class="mb-5">
