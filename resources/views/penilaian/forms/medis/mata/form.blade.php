<form action="{{url('/penilaian-medis-mata/update')}}" method="post">
    @csrf
    <div class="row mb-3">
    ...
    <div>
        ...
        <div class="row align-items-end">
            ...
            <div class="col-2 mb-2">
                ...
                <div class="input-group">
                    <input type="text" id="suhu" name="suhu" class="form-control" value="{{ !empty($penilaian->suhu) ? $penilaian->suhu : 'jhon' }}">
            ...
            <div class="col-6 mb-2 ">
                ...
                <input type="text" class="form-control" name="nyeri" id='nyeri' value="{{ !empty($penilaian->nyeri) ? $penilaian->nyeri : '' }}">
            </div>
            <div class="col-6 mb-2 ">
                <label for="status" class="form-label">Status Nutrisi</label>
                <input type="text" class="form-control" name="status" id='status' value="{{ !empty($penilaian->status) ? $penilaian->status : '' }}">
            </div>
        </div>
    </div>
    <hr class="mb-5">
        ...
        <h5 class="text-start">III. STATUS OFTAMOLOGIS</h5>
         <div class="row align-items-end ">
            ...
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="visuskanan" id='visuskanan' value="{{ !empty($penilaian->visuskanan) ? $penilaian->visuskanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Visus SC</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="visuskiri" id='visuskiri' value="{{ !empty($penilaian->visuskiri) ? $penilaian->visuskiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="cckanan" id='cckanan' value="{{ !empty($penilaian->cckanan) ? $penilaian->cckanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">CC</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="cckiri" id='cckiri' value="{{ !empty($penilaian->cckiri) ? $penilaian->cckiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="palkanan" id='palkanan' value="{{ !empty($penilaian->palkanan) ? $penilaian->palkanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Palebra</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="palkiri" id='palkiri' value="{{ !empty($penilaian->palkiri) ? $penilaian->palkiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="conkanan" id='conkanan' value="{{ !empty($penilaian->conkanan) ? $penilaian->conkanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Conjungtiva</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="conkiri" id='conkiri' value="{{ !empty($penilaian->conkiri) ? $penilaian->conkiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="corneakanan" id='corneakanan' value="{{ !empty($penilaian->corneakanan) ? $penilaian->corneakanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Cornea</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="corneakiri" id='corneakiri' value="{{ !empty($penilaian->corneakiri) ? $penilaian->corneakiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="coakanan" id='coakanan' value="{{ !empty($penilaian->coakanan) ? $penilaian->coakanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Coa</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="coakiri" id='coakiri' value="{{ !empty($penilaian->coakiri) ? $penilaian->coakiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="pupilkanan" id='pupilkanan' value="{{ !empty($penilaian->pupilkanan) ? $penilaian->pupilkanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Pupil</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="pupilkiri" id='pupilkiri' value="{{ !empty($penilaian->pupilkiri) ? $penilaian->pupilkiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="lensakanan" id='lensakanan' value="{{ !empty($penilaian->lensakanan) ? $penilaian->lensakanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Lensa</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="lensakiri" id='lensakiri' value="{{ !empty($penilaian->lensakiri) ? $penilaian->lensakiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="funduskanan" id='funduskanan' value="{{ !empty($penilaian->funduskanan) ? $penilaian->funduskanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Fundus Media</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="funduskiri" id='funduskiri' value="{{ !empty($penilaian->funduskiri) ? $penilaian->funduskiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="papilkanan" id='papilkanan' value="{{ !empty($penilaian->papilkanan) ? $penilaian->papilkanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Papil</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="papilkiri" id='papilkiri' value="{{ !empty($penilaian->papilkiri) ? $penilaian->papilkiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="retinakanan" id='retinakanan' value="{{ !empty($penilaian->retinakanan) ? $penilaian->retinakanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Retina</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="retinakiri" id='retinakiri' value="{{ !empty($penilaian->retinakiri) ? $penilaian->retinakiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="makulakanan" id='makulakanan' value="{{ !empty($penilaian->makulakanan) ? $penilaian->makulakanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">Makula</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="makulakiri" id='makulakiri' value="{{ !empty($penilaian->makulakiri) ? $penilaian->makulakiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="tiokanan" id='tiokanan' value="{{ !empty($penilaian->tiokanan) ? $penilaian->tiokanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">TIO</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="tiokiri" id='tiokiri' value="{{ !empty($penilaian->tiokiri) ? $penilaian->tiokiri : '' }}">
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="mbokanan" id='mbokanan' value="{{ !empty($penilaian->mbokanan) ? $penilaian->mbokanan : '' }}">
            </div>
            <div class="col-2 mb-3 text-center">
                <label for="">MBO</label>
            </div>
            <div class="col-5 mb-2">
                <input type="text" class="form-control" name="mbokiri" id='mbokiri' value="{{ !empty($penilaian->mbokiri) ? $penilaian->mbokiri : '' }}">
            </div>
         </div>
    </div>
    <hr class="mb-5">
    <div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-4">
                ...
                <textarea class="form-control" id="penunjang" name="penunjang" rows="3">{{ !empty($penilaian->penunjang) ? $penilaian->penunjang : '' }}</textarea>
            </div>
            <div class="col-6">
                <label for="tes" class="form-label">Tes Penglihatan</label>
                <textarea class="form-control" id="tes" name="tes" rows="3">{{ !empty($penilaian->tes) ? $penilaian->tes : '' }}</textarea>
            </div>
            <div class="col-6">
        ...
        <div class="row mb-2">
            <div class="col">
             ...
             <div class="col">
                ...
                <textarea class="form-control" id="diagnosisbdg" name="diagnosisbdg" rows="3">{{ !empty($penilaian->diagnosisbdg) ? $penilaian->diagnosisbdg : '' }}</textarea>
            </div>
        </div>
    </div>
    <hr class="mb-5">
