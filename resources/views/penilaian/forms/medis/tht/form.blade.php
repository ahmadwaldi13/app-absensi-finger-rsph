<form action="{{url('/penilaian-medis-tht/update')}}" method="post">
    @csrf
    <div class="row mb-3">
...
<div>
    ...
    <div class="row align-items-end">
        ...
        <div class="col-6 mb-2 ">
            ...
            <input  type="text" class="form-control" name="status_nutrisi" id='status_nutrisi' value="{{!empty($penilaian->status_nutrisi) ? $penilaian->status_nutrisi : ''}}">
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <label for="kondisi" class="form-label">Kondisi Umum</label>
            <textarea  class="form-control" id="kondisi" name="kondisi" rows="5">{{!empty($penilaian->kondisi) ? $penilaian->kondisi : ''}}</textarea>
        </div>
    </div>
</div>
<hr class="mb-5">
...
<div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-6">
            ...
            <textarea  class="form-control" id="tes_pendengaran" name="tes_pendengaran" rows="3">{{!empty($penilaian->tes_pendengaran) ? $penilaian->tes_pendengaran : ''}}</textarea>
        </div>
    ...
    <div class="row mb-2">
        <div class="col">
         ...
         <div class="col">
            ...
            <textarea  class="form-control" id="diagnosisbanding" name="diagnosisbanding" rows="3">{{!empty($penilaian->diagnosisbanding) ? $penilaian->diagnosisbanding : ''}}</textarea>
        </div>
    </div>
</div>
<hr class="mb-5">
<div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-6">
            ...
            <textarea  class="form-control" id="tatalaksana" name="tatalaksana" rows="3">{{!empty($penilaian->tatalaksana) ? $penilaian->tatalaksana : ''}}</textarea>
        </div>
