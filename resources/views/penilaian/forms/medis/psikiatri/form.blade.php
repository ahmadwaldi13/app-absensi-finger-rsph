<div class="row mb-3">
    ...
    <div>
        ...
        <div class="row align-items-end">
            ...
            <div class="col-6 mb-2">
                ...
                <textarea class="form-control" id="rpo" name="rpo" rows="3">{{ !empty($penilaian->alergi) ? $penilaian->alergi : '' }}</textarea>
            </div>
            <div class="col-6 mb-2 ">
    ...
    <div>
        ...
        <div class="row align-items-end">
            <div class="col-6 mb-2">
                ...
                <textarea class="form-control" id="penampilan" name="penampilan"
                    rows="3">{{ !empty($penilaian->penampilan) ? $penilaian->penampilan : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="gangguan_persepsi" class="form-label">Ganguan Persepsi</label>
                <textarea class="form-control" id="gangguan_persepsi" name="gangguan_persepsi"
                    rows="3">{{ !empty($penilaian->gangguan_persepsi) ? $penilaian->gangguan_persepsi : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="pembicaraan" class="form-label">Pembicaraan</label>
                <textarea class="form-control" id="pembicaraan" name="pembicaraan"
                    rows="3">{{ !empty($penilaian->pembicaraan) ? $penilaian->pembicaraan : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="proses_pikir" class="form-label">Proses Pikir & Isi Pikir</label>
                <textarea class="form-control" id="proses_pikir" name="proses_pikir"
                    rows="3">{{ !empty($penilaian->proses_pikir) ? $penilaian->proses_pikir : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="psikomotor" class="form-label">Psikomotor</label>
                <textarea class="form-control" id="psikomotor" name="psikomotor"
                    rows="3">{{ !empty($penilaian->psikomotor) ? $penilaian->psikomotor : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="pengendalian_impuls" class="form-label">Pengendalian Implus</label>
                <textarea class="form-control" id="pengendalian_impuls" name="pengendalian_impuls"
                    rows="3">{{ !empty($penilaian->pengendalian_impuls) ? $penilaian->pengendalian_impuls : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="sikap" class="form-label">Sikap</label>
                <textarea class="form-control" id="sikap" name="sikap"
                    rows="3">{{ !empty($penilaian->sikap) ? $penilaian->sikap : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="tilikan" class="form-label">Tilikan</label>
                <textarea class="form-control" id="tilikan" name="tilikan"
                    rows="3">{{ !empty($penilaian->tilikan) ? $penilaian->tilikan : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="mood" class="form-label">Mood/Afek</label>
                <textarea class="form-control" id="mood" name="mood"
                    rows="3">{{ !empty($penilaian->mood) ? $penilaian->mood : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="rta" class="form-label">Reality Testing Ability</label>
                <textarea class="form-control" id="rta" name="rta"
                    rows="3">{{ !empty($penilaian->rta) ? $penilaian->rta : '' }}</textarea>
            </div>
            <div class="col-6 mb-2">
                <label for="fungsi_kognitif" class="form-label">Fungsi Kognitif</label>
                <textarea class="form-control" id="fungsi_kognitif" name="fungsi_kognitif"
                    rows="3">{{ !empty($penilaian->fungsi_kognitif) ? $penilaian->fungsi_kognitif : '' }}</textarea>
            </div>
    ...
    <div>
        ...
        <div class="row align-items-end">
            <div class="col-3 mb-2">
                ...
                <select class="form-select" id="keadaan" name="keadaan" aria-label="Default select ">
                    ...
                    <option value="Sakit Ringan" {{ $penilaian->keadaan === 'Sakit Ringan' ? 'selected' : '' }}>Sakit
                        Ringan</option>
                    <option value="Sakit Sedang" {{ $penilaian->keadaan === 'Sakit Sedang' ? 'selected' : '' }}>Sakit
                        Sedang</option>
                    <option value="Sakit Berat" {{ $penilaian->keadaan === 'Sakit Berat' ? 'selected' : '' }}>Sakit
                        Berat</option>
                </select>
            </div>
            <div class="col-3 mb-2">
                ...
                <select class="form-select" id="kesadaran" name="kesadaran" aria-label="Default select ">
                    <option value="-" {{ $penilaian->kesadaran === '-' ? 'selected' : '' }}>Pilih Kesadaran
                    </option>
                    <option value="Compos Mentis" {{ $penilaian->kesadaran === 'Compos Mentis' ? 'selected' : '' }}>
                        Compos Mentis</option>
                    <option value="Apatis" {{ $penilaian->kesadaran === 'Apatis' ? 'selected' : '' }}>Apatis</option>
                    <option value="Somnolen" {{ $penilaian->kesadaran === 'Somnolen' ? 'selected' : '' }}>Somnolen
                    </option>
            ...
            <div class="col-2 mb-2">
                ...
                <div class="input-group">
                    <input type="text" id="gcs" name="gcs" value="{{ !empty($penilaian->gcs) ? $penilaian->gcs : '' }}"
                        class="form-control">
                </div>
            </div>
            ...
            <div class="col-2 mb-2">
                ...
                <div class="input-group">
                    <input type="text" id="tb" name="tb" value="{{ !empty($penilaian->tb) ? $penilaian->tb : '' }}"
                        class="form-control">
            ...
            <div class="col-2 mb-2">
                ...
                <div class="input-group">
                    <input type="text" id="bb" name="bb" value="{{ !empty($penilaian->bb) ? $penilaian->bb : '' }}"
                        class="form-control">
            ...
            <div class="col-2 mb-2">
                ...
                <div class="input-group">
                    <input type="text" name="td" value="{{ !empty($penilaian->td) ? $penilaian->td : '' }}" id="td"
                        class="form-control">
            ...
            <div class="col-2 mb-2">
                ...
                <div class="input-group">
                    <input type="text" id="rr" name="rr" value="{{ !empty($penilaian->rr) ? $penilaian->rr : '' }}"
                        class="form-control">
                    <span class="input-group-text" id="ModalPetugas">x / Menit</span>
                </div>
            </div>
            ...
            <div class="col-2 mb-2">
                ...
                <div class="input-group">
                    <input type="text" id="spo" name="spo" value="{{ !empty($penilaian->spo) ? $penilaian->spo : '' }}"
                        class="form-control">
                    <span class="input-group-text" id="ModalPetugas">%</span>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-6 row">
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="kepala" name="kepala" aria-label="Default select ">
                        <option value="-" {{ $penilaian->kepala === '-' ? 'selected' : '' }}>Pilih Keadaan
                        </option>
                        ...
                        <option value="Tidak Diperiksa" {{ $penilaian->kepala === 'Tidak Diperiksa' ? 'selected' : ''
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="abdomen" name="abdomen" aria-label="Default select ">
                        <option value="-" {{ $penilaian->abdomen === '-' ? 'selected' : '' }}>Pilih Keadaan
                        </option>
                        ...
                        <option value="Tidak Diperiksa" {{ $penilaian->abdomen === 'Tidak Diperiksa' ? 'selected' : ''
                            }}>Tidak Diperiksa</option>
                    </select>
                </div>
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="gigi" name="gigi" aria-label="Default select ">
                        ...
                        <option value="Abnormal" {{ $penilaian->gigi === 'Abnormal' ? 'selected' : '' }}>Abnormal
                        </option>
                        <option value="Tidak Diperiksa" {{ $penilaian->gigi === 'Tidak Diperiksa' ? 'selected' : ''
                            }}>Tidak Diperiksa</option>
                    </select>
                </div>
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="genital" name="genital" aria-label="Default select ">
                        <option value="-" {{ $penilaian->genital === '-' ? 'selected' : '' }}>Pilih Keadaan
                        </option>
                        <option value="Normal" {{ $penilaian->genital === 'Normal' ? 'selected' : '' }}>Normal
                        </option>
                        <option value="Abnormal" {{ $penilaian->genital === 'Abnormal' ? 'selected' : '' }}>Abnormal
                        </option>
                        <option value="Tidak Diperiksa" {{ $penilaian->genital === 'Tidak Diperiksa' ? 'selected' : ''
                            }}>Tidak Diperiksa</option>
                    </select>
                </div>
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="tht" name="tht" aria-label="Default select ">
                        ...
                        <option value="Abnormal" {{ $penilaian->tht === 'Abnormal' ? 'selected' : '' }}>Abnormal
                        </option>
                        <option value="Tidak Diperiksa" {{ $penilaian->tht === 'Tidak Diperiksa' ? 'selected' : '' }}>
                            Tidak Diperiksa</option>
                    </select>
                </div>
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="ekstremitas" name="ekstremitas" aria-label="Default select ">
                        <option value="-" {{ $penilaian->ekstremitas === '-' ? 'selected' : '' }}>Pilih Keadaan
                        </option>
                        ...
                        <option value="Abnormal" {{ $penilaian->ekstremitas === 'Abnormal' ? 'selected' : '' }}>
                            Abnormal</option>
                        <option value="Tidak Diperiksa" {{ $penilaian->ekstremitas === 'Tidak Diperiksa' ? 'selected' :
                            '' }}>
                            Tidak Diperiksa
                        </option>
                    </select>
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="thoraks" name="thoraks" aria-label="Default select ">
                        <option value="-" {{ $penilaian->thoraks === '-' ? 'selected' : '' }}>Pilih Keadaan
                        </option>
                        ...
                        <option value="Tidak Diperiksa" {{ $penilaian->thoraks === 'Tidak Diperiksa' ? 'selected' : ''
                            }}>Tidak Diperiksa</option>
                    </select>
                </div>
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="kulit" name="kulit" aria-label="Default select ">
                        <option value="-" {{ $penilaian->kulit === '-' ? 'selected' : '' }}>Pilih Keadaan
                        </option>
                        <option value="Normal" {{ $penilaian->kulit === 'Normal' ? 'selected' : '' }}>Normal</option>
                        <option value="Abnormal" {{ $penilaian->kulit === 'Abnormal' ? 'selected' : '' }}>Abnormal
                        </option>
                        <option value="Tidak Diperiksa" {{ $penilaian->kulit === 'Tidak Diperiksa' ? 'selected' : ''
                            }}>Tidak Diperiksa</option>
                    </select>
                </div>
            </div>
            <div class="col-6">
                ...
                <textarea class="form-control h-75" id="ket_fisik" name="ket_fisik"
                    rows="5">{{ !empty($penilaian->ket_fisik) ? $penilaian->ket_fisik : '' }}</textarea>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="row mb-2">
            ...
            <textarea class="form-control" id="penunjang" name="penunjang"
                rows="3">{{ !empty($penilaian->penunjang) ? $penilaian->penunjang : '' }}</textarea>
        </div>
    </div>
    <hr class="mb-5">
    <div>
        ...
        <div class="row mb-2">
            ...
            <textarea class="form-control" id="diagnosis" name="diagnosis"
                rows="3">{{ !empty($penilaian->diagnosis) ? $penilaian->diagnosis : '' }}</textarea>
        </div>
    </div>
    <hr class="mb-5">
    <div>
        ...
        <div class="row mb-2">
            ...
            <textarea class="form-control" id="tata" name="tata"
                rows="3">{{ !empty($penilaian->tata) ? $penilaian->tata : '' }}</textarea>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="row mb-2">
            ...
            <textarea class="form-control" id="konsulrujuk" name="konsulrujuk"
                rows="3">{{ !empty($penilaian->konsulrujuk) ? $penilaian->konsulrujuk : '' }}</textarea>
        </div>
    </div>
