<form action="{{url('/penilaian-medis-igd/update')}}" method="post">
    @csrf
    <div class="row mb-3">
        ...
        <div class="row align-items-end">
            <div class="col-3 mb-2">
                ...
                <select class="form-select" id="keadaan" name="keadaan" aria-label="Default select ">
                    <option value="-" {{$penilaian->keadaan === "-" ? 'selected' : ''}} selected>Pilih Keadaan</option>
            ...
            <div class="col-3 mb-2">
                ...
                <select class="form-select" id="kesadaran" name="kesadaran" aria-label="Default select ">
                    <option value="-" {{$penilaian->kesadaran === "-" ? 'selected' : ''}} selected>Pilih Kesadaran</option>
            ...
            <div class="col-6 row">
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="kepala" name="kepala" aria-label="Default select ">
                        <option value="-" {{$penilaian->kepala === "-" ? 'selected' : ''}} selected>Pilih Keadaan</option>
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="abdomen" name="abdomen" aria-label="Default select ">
                        <option value="-" {{$penilaian->abdomen === "-" ? 'selected' : ''}} selected>Pilih Keadaan</option>
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="gigi" name="gigi" aria-label="Default select ">
                        <option value="-" {{$penilaian->gigi === "-" ? 'selected' : ''}} selected>Pilih Keadaan</option>
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="genital" name="genital" aria-label="Default select ">
                        <option value="-" {{$penilaian->genital === "-" ? 'selected' : ''}} selected>Pilih Keadaan</option>
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="mata" name="mata" aria-label="Default select ">
                        <option value="-" {{$penilaian->mata === "-" ? 'selected' : ''}} selected>Pilih Keadaan</option>
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="ekstremitas" name="ekstremitas" aria-label="Default select ">
                        <option value="-" {{$penilaian->ekstremitas === "-" ? 'selected' : ''}} selected>Pilih Keadaan</option>
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="thoraks" name="thoraks" aria-label="Default select ">
                        <option value="-" {{$penilaian->thoraks === "-" ? 'selected' : ''}} selected>Pilih Keadaan</option>
                ...
                <div class="col-6 mb-2">
                    ...
                    <select class="form-select" id="leher" name="leher" aria-label="Default select ">
                        <option value="-" {{$penilaian->leher === "-" ? 'selected' : ''}} selected>Pilih Keadaan</option>
                        <option value="Normal" {{$penilaian->leher === "Normal" ? 'selected' : ''}} >Normal</option>
                        <option value="Abnormal" {{$penilaian->leher === "Abnormal" ? 'selected' : ''}}>Abnormal</option>
                        <option value="Tidak Diperiksa" {{$penilaian->leher === "Tidak Diperiksa" ? 'selected' : ''}}>Tidak Diperiksa</option>
                    </select>
                </div>
            </div>
            <div class="col-6">
    ...
    <div>
        ...
        <div class="row mb-2">
            <div class="col">
                ...
                <textarea  class="form-control" id="ekg" name="ekg" rows="3">{{!empty($penilaian->ekg) ? $penilaian->ekg : ''}}</textarea>
            </div>
            <div class="col">
