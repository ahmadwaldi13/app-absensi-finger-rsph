    ...
    <div class="row justify-content-start align-items-end mb-3">
        ...
        <div class="col-lg-3">
            <div class='bagan_form'>
                <label for="kode" class="form-label">Kode Berkas<span class="text-danger">*</span></label>
        ...
        <div class="col-lg-3">
            <div class='bagan_form'>
                <label for="nama" class="form-label">Nama Berkas<span class="text-danger">*</span></label>
        ...
        <div class="col-lg-3">
            <div class='bagan_form'>
                <label for="prefix" class="form-label">Alias Folder Di Sistem<span
        ...
        <div class="col-lg-3">
            <div class="bagan_form">
                <label for="prefix" class="form-label">Type Berkas</label>
                <div class="form-check form-switch">
                    <?php $checked=!empty($model->type) ? ($model->type == 1 ? 'checked' : '') : ''; ?>
                    <input class="form-check-input" type="checkbox" name="type" {{ $checked }}  value="1" id="flexSwitchCheckChecked">
                </div>
            </div>
        </div>
    </div>
