                                        ...
                                        <div class="jadwal-display">
                                           ...
                                           @if($jadwal_tgl && !$cuti_tgl)
                                            <form method="POST"
                                                ...
                                                <input type="hidden" name="id" value="{{ $jadwal_tgl['id'] }}">
                                                <input type="hidden" name="id_karyawan" value="{{ $item->id_karyawan }}">
                                                <input type="hidden" name="tanggal" value="{{ $tgl_key }}">
                                                ...
                                                <select name="id_shift"
                                                    ...
                                                    @foreach($list_shift as $shift)
                                                        <option value="{{ $shift->id_jenis_jadwal }}"
                                                            {{ $jadwal_tgl['id_jenis_jadwal'] == $shift->id_jenis_jadwal ? 'selected' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.jadwal-cell').forEach(function(cell) {

        cell.addEventListener('click', function(e) {

            let display = this.querySelector('.jadwal-display');
            let form = this.querySelector('.jadwal-form');
    ...
    cell.addEventListener('click', function(){
        ...
        let display = this.querySelector('.jadwal-display');
        let select  = this.querySelector('.jadwal-edit');
