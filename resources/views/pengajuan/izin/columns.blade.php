                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if(!empty($item->file_pendukung))
                                    <button type="button" class="btn btn-sm btn-outline-primary btn-view-file" 
                            ...
                            <td class="text-center">
                                <div class="btn-group gap-2" role="group">
                                    {!! (new \App\Http\Traits\AuthFunction)->setPermissionButton([$router_name->uri.'/update',['data_sent'=>$item->id_karyawan],'update']) !!}
                                    {!! (new \App\Http\Traits\AuthFunction)->setPermissionButton([$router_name->uri.'/delete',['data_sent'=>$item->id_karyawan],'delete'],['modal']) !!}
                                </div>
                            </td>
                        </tr>
                        @endforeach
