...
@section('content')
    <div>
        @include('layouts.tab_lab',['active'=>2])
        <div class="card border-top-0 px-4 py-5">

            @include('patologi-anatomi.form')
    
            @include('patologi-anatomi.columns')
        </div>
    </div>
@endsection
...
@push('custom-script')
    ...
    <script src="{{ asset('js/patologi-anatomi/patologi_anatomi.js') }}"></script>
@endpush