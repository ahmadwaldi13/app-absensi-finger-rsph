                ...
                @if(!empty($list_data))
                    @foreach($list_data as $key => $item)
                        ...
                        <tr>
                            ...
                            <td>{{ $waktu_hasil  }}</td>
                            <td>
                                <a href='patologi-anatomi/view' class='btn btn-kecil btn-info modal-remote' data-modal-key='{{ $kode }}' data-modal-width='90%' data-modal-title='View Anatomi Klinis'><i style='color:#fff;' class="fa-solid fa-circle-info"></i></a>
                                @if($check_akses)
                                <a href='patologi-anatomi/delete' class='btn btn-kecil btn-danger modal-remote-delete' data-modal-key='{{ $kode }}' data-confirm-message="Apakah anda yakin menghapus data ini ?"><i class="fa-solid fa-trash"></i></a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
