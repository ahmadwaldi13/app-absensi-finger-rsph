...
<div>
    ...
    <div class='bagan-data-table'>
        ...
        <div>
            <form action="tindakan-petugas/tindakan-action" method="POST">
                @csrf
                    ...
                    <table class="table border data-table table-responsive-tablet gsf_kode_item" data-gsf-type='table'>
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="py-3">NIP</th>
                                <th scope="col" class="py-3">Petugas Yg Menangani</th>
                        ...
                        <tbody>
                            @foreach($tindakaPetugasList as $item)
                                @php
                                    ...
                                    $kode=$item['no_rawat'].'@'.$item['kd_jenis_prw'].'@'.$item['nip'].'@'.$item['tgl_perawatan'].'@'.$item['jam_rawat'];
                                @endphp
                                <tr>
