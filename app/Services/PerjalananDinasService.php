...
class PerjalananDinasService extends BaseService
{
    ...
    function getList($params=[],$type=''){
        $query = $this->perjalananDinas
            ->select('id_spd','ref_perjalanan_dinas.id_karyawan','ref_karyawan.nip','ref_karyawan.nm_karyawan','nm_jabatan','nm_departemen','nm_ruangan','ref_perjalanan_dinas.jenis_dinas','ref_perjalanan_dinas.tgl_mulai','ref_perjalanan_dinas.tgl_selesai','ref_perjalanan_dinas.jumlah')
