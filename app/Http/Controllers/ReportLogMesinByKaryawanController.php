...
class ReportLogMesinByKaryawanController extends \App\Http\Controllers\MyAuthController
{
    ...
    public function __construct()
    {
        ...
        $this->title = 'Report Absensi Histori Dari Karyawan';
        $this->breadcrumbs = [
    ...
    function actionIndex(Request $request){
        ...
        if(!empty($request->cari_data)){
            ...
            $list_data=(new \App\Services\DataPresensiService)->get_log_mesin_by_karyawan($paramter_search,1)
    ...
    public function actionCetak(Request $request){
        ...
        if($list_data){
            ...
            $file_='format_report_log_mesin_by_karyawan.xlsx';

            $nama_excel="rekap_log_mesin_by_karyawan";
