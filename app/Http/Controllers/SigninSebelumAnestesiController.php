...
class SigninSebelumAnestesiController extends RmOperasiMasterController
{
    public $base_route = "/signin-sebelum-anestesi";
    public $table_list = [
        "rmoperasi" => "signin_sebelum_anestesi"
    ];
    public $view_list = [
        "index" => 'signin-sebelum-anestesi.index',
        "form_update" => 'signin-sebelum-anestesi.form_update',
        "form" => 'signin-sebelum-anestesi.form',
        "view" => 'signin-sebelum-anestesi.view',
    ];

    public $additional_parameter_view =[];
    public $penilaian_source_method = "get_signin_sebelum_anestesi";
