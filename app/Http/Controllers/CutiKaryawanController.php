...
class CutiKaryawanController extends \App\Http\Controllers\MyAuthController
{
    ...
    function actionIndex(Request $request)
    {
        ...
        $list_cuti=(new \App\Services\CutiKaryawanService())->getList($paramater,1)->paginate(!empty($request->per_page) ? $request->per_page : 15);
