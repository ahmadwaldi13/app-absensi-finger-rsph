...
class PenilaianPreOperasiController extends RmOperasiMasterController
{
    public $base_route = "/rmoperasi-nilai-pre-operasi";
    public $table_list = [
        "rmoperasi" => "penilaian_pre_operasi"
    ];
    public $view_list = [
        "index" => 'penilaian-pre-operasi.index',
        "form_update" => 'penilaian-pre-operasi.form_update',
        "form" => 'penilaian-pre-operasi.form',
        "view" => 'penilaian-pre-operasi.view',
    ];

    public $additional_parameter_view =[];
    public $penilaian_source_method = "get_penilaian_pre_operasi";
