...
class CheckListPreOperasiController extends RmOperasiMasterController
{
    public $base_route = "/check-list-pre-operasi";
    public $table_list = [
        "rmoperasi" => "checklist_pre_operasi"
    ];
    public $view_list = [
        "index" => 'check-list-pre-operasi.index',
        "form_update" => 'check-list-pre-operasi.form_update',
        "form" => 'check-list-pre-operasi.form',
        "view" => 'check-list-pre-operasi.view',
    ];

    public $additional_parameter_view =[];
    public $penilaian_source_method = "get_checklist_pre_operasi";
